...
# psivera  2003-10-22 added module's $env(PYTHON_SITE_PACKAGES) to PYTHONPATH if exists
...
# the module under test to include it's shared libraries
    ...
    if { [file isdirectory ../lib] } {
        ...
        set libPath [pwd]
        cd ..
        set libSitePath [pwd]/$env(PYTHON_SITE_PACKAGES)
        cd test
    ...
    if {[info exists env(PYTHONPATH)]} {
        if {![catch {set env(PYTHONPATH) $libSitePath:$env(PYTHONPATH)}]} {
