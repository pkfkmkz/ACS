				 ...
				 CORBA::Boolean remaining_activations)
{
    ...
    if (remaining_activations==0) {
        ...
        ACS_LOG(LM_RUNTIME_CONTEXT, "maci::MACIServantManager::etherealize", (LM_WARNING, "Skipping etherealization of component '%s' as there were POA activations remaining.", id.in()));
    }
}
