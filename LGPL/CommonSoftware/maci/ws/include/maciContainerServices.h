...

{
 ...
 private:
  ...
  acsalarm::AlarmSourceThread* m_alarmSourceThread_p;
  
  // Reference from container initialization to CDB DAL
  CDB::DAL_var m_cdb_dal_ref;

  static ACE_Recursive_Thread_Mutex m_offshootMutex;
