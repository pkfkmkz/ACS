...
CORBA::Boolean MaciTestClientImpl::ping() {
    ACS_SHORT_LOG((LM_INFO, "MaciTestClientImpl::ping (client '%s', action %d)", m_name.c_str(), m_onPing));
    if (m_onPing == 0)
      return true;
    if (m_onPing == 1)
      return false;
...
void MaciTestClientImpl::pingCB(maci::PingCallback_ptr cb) {
    ACS_SHORT_LOG((LM_INFO, "MaciTestClientImpl::pingCB(client '%s', action %d)", m_name.c_str(), m_onPing));
    if (m_onPing == 0)
      cb->ping(true);
    if (m_onPing == 1)
      cb->ping(false);
...
void MaciTestContainerImpl::pingCB(maci::PingCallback_ptr cb) {
    ACS_SHORT_LOG((LM_INFO, "MaciTestContainerImpl::pingCB"));
    MaciTestClientImpl::pingCB(cb);
}
...
void MaciTestAdministratorImpl::pingCB(maci::PingCallback_ptr cb) {
    ACS_SHORT_LOG((LM_INFO, "MaciTestAdministratorImpl::pingCB"));
    MaciTestClientImpl::pingCB(cb);
}
