...
int main (int argc, char **argv)
{
	...
	try
	    {
	    ComponentSmartPtr<MACI_TEST::MaciTestClass> foo(make_shared_component<MACI_TEST::MaciTestClass>());
	...
	try
	    {
	    ComponentSmartPtr<MACI_TEST::MaciTestClass> foo(maci::make_shared_component(&client, true, client.getComponent<MACI_TEST::MaciTestClass>("MACI04", 0, true)));
	    assert(foo.get() != 0);
	...
	try
	    {
	    ComponentSmartPtr<MACI_TEST::MaciTestClass> bar = client.getComponentSmartPtr<MACI_TEST::MaciTestClass>("MACI04", 0, true);
	...
	try
	    {
	    ComponentSmartPtr<MACI_TEST::MaciTestClass> foo = client.getComponentSmartPtr<MACI_TEST::MaciTestClass>("MACI04", 0, true);
	    ComponentSmartPtr<MACI_TEST::MaciTestClass> bar = client.getComponentNonStickySmartPtr<MACI_TEST::MaciTestClass>("MACI04");
