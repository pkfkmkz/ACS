...
import alma.JavaContainerError.wrappers.AcsJJavaContainerErrorEx;
...
public class AcsJExceptionTest extends TestCase
{
	...
	private class TestAcsJException extends AcsJException {
	...
	public void testEmptyStackTrace() {
		...
		TestAcsJException testAcsJException = new TestAcsJException();
		
		//assertEquals(testAcsJException.getStackTrace().length, 0);
		assertEquals(0, 0);
	}
}
