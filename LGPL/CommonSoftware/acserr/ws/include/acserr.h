...
/**
 * Helper function for generic exception handling. Requires C++11
 */
void handle_exception(std::string function, bool rethrow=false);
 ...
 /**
  ...
  protected:
   ...
   /**
    ...
    void prepareMsg() const;
    std::string prepareMsg(ACSErr::ErrorTrace* et, unsigned int depth) const;

    ACSErr::ErrorTrace *m_errorTracePtr;
//& m_errorTraceRef;
    ACSErr::ErrorTrace *m_current;
    unsigned int m_depth;
    mutable CORBA::String_var m_errorMsg;
