...
static const char *rcsId="@(#) $Id: acserrLegacy.cpp,v 1.21 2012/01/20 22:07:43 tstaig Exp $"; 
...
bool ACSError::init ()
{
    ...
    {
    	ACS_SHORT_LOG((LM_WARNING, "Error while installing the new SIGSEGV signal handler: %s!", std::strerror(errno)));
    }//if
#endif //!MAKE_VXWORKS
    initialized = true;
