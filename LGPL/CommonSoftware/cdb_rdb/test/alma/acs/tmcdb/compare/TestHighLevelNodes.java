 ...
 */
public class TestHighLevelNodes extends TestCase {
...
//		System.out.println("xs = "+xbool+"; rs = "+rbool);
	...
	public void testXmlMACI() throws Exception {
		...
		assertThat(xmlXml).and(rdbXml).areSimilar(); //This fails at the moment because XML returns namespace info, TMCDB doesn't
	}
