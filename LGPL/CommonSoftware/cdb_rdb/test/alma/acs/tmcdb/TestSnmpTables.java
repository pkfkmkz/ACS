...
public class TestSnmpTables extends TestCase {
	...
	public void testFillSnmpTmcdb() throws Exception {
    	...
    	try {
    		...
    		sink.setTrapPort(Integer.valueOf(10162));
    		...
    		socket1.setSocketNumber(Integer.valueOf(1));
    		...
    		socket2.setSocketNumber(Integer.valueOf(2));
    		...
    		socket3.setSocketNumber(Integer.valueOf(3));
