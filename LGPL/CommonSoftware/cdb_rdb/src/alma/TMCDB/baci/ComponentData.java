...
public class ComponentData implements java.io.Serializable, ExtraDataFeature {
	...
	private int monitoringThreadMaxStartDelay;

	/**
	 * @return the actionThreadStackSize
	 */
	public int getActionThreadStackSize() {
		return actionThreadStackSize;
	}
	/**
	 * @param actionThreadStackSize the thread stack size for actions
	 */
	 ...
	 */
	public int getMonitoringThreadStackSize() {
		return monitoringThreadStackSize;
	}
	/**
	 * @param monitoringThreadStackSize the the thread stack size for monitoring
	 */
	...
	/**
	 * @return the monitoringThreadMaxStartDelay
	 */
	public int getMonitoringThreadMaxStartDelay() {
		return monitoringThreadMaxStartDelay;
	}
	/**
	 * @param monitoringThreadMaxStartDelay the maximum delay to start monitoring a component
	 */
	public void setMonitoringThreadMaxStartDelay(int monitoringThreadMaxStartDelay) {
		this.monitoringThreadMaxStartDelay = monitoringThreadMaxStartDelay;
	}
