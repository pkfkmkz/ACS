...
public class Component extends ComponentNode implements ExtraDataFeature {
    ...
    public String toString() {
        ...
        s += "\tMonitoringThreadMaxStartDelay: " + MonitoringThreadMaxStartDelay + newline;
	 ...
	 */
	public Integer getMonitoringThreadMaxStartDelay() {
		return MonitoringThreadMaxStartDelay;
	}

	/**
	 * @param monitoringThreadMaxStartDelay the MonitoringThreadMaxStartDelay to set
	 */
	public void setMonitoringThreadMaxStartDelay(int monitoringThreadMaxStartDelay) {
		MonitoringThreadMaxStartDelay = monitoringThreadMaxStartDelay;
	}
}
