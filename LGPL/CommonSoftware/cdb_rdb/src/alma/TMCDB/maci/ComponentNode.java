...
public class ComponentNode implements java.io.Serializable {
    static private final String newline = System.getProperty("line.separator");

    // hierarchical support
    // must be public to be accessible, but should not have getter to be come visible as node
    @SuppressWarnings("unused")
	public Map<String, ComponentNode> e = new LinkedHashMap<String, ComponentNode>();
    ...
    public String toString() {
    	String s =  "ComponentNode:" + newline;

    	s += "\t(subcomponents): " + e + newline;
