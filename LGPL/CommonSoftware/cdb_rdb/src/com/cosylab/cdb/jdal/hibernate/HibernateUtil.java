...
public class HibernateUtil {
    ...
    throws HibernateUtilException {
        try {
            Connection c = ((SessionImplementor)session).getJdbcCoordinator().getLogicalConnection().manualDisconnect();
            ((SessionImplementor)session).getJdbcCoordinator().getLogicalConnection().manualReconnect(c);
