...
public class XSDElementTypeResolver {
    	...
    	throws SAXException, IOException, URIException, XMLException
    {
        ...
        Iterator structures;
        for (structures = schema.getElementDecls().iterator(); structures.hasNext(); )
        {
        	ElementDecl elementDecl = (ElementDecl) structures.next();
        ...
        {
	        for (structures = schema.getComplexTypes().iterator(); structures.hasNext(); )
	        {
	        	ComplexType complexType = (ComplexType) structures.next();
