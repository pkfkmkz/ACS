...
public class Location implements Serializable {
	...
	public Location(String building, String floor, String room, String mnemonic, String position) {
		if (building != null)
			e.put("building", new ElementValue(building));
		if (floor != null)
			e.put("floor", new ElementValue(floor));
		if (room != null)
			e.put("room", new ElementValue(room));
		if (mnemonic != null)
			e.put("mnemonic", new ElementValue(mnemonic));
		if (position != null)
			e.put("position", new ElementValue(position));
	}
