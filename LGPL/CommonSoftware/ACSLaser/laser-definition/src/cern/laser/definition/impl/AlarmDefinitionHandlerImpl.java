 ...
 */
  ...
  private AlarmDefinition unmarshalAlarmDefinition(Object definition) {
  	throw new UnsupportedOperationException(); /*AlarmDefinition result = new AlarmDefinition(definition.getFaultFamily(), definition.getFaultMember(), Integer.valueOf(definition.getFaultCode()));
    ...
    result.setPriority(Integer.valueOf(definition.getPriority()));
    result.setCause(definition.getCause());
    result.setAction(definition.getAction());
    result.setConsequence(definition.getConsequence());
    result.setInstant(Boolean.valueOf(definition.getInstant()));
    result.setHelpURL(definition.getHelpUrl());
    result.setSourceName(definition.getSourceName());
    ...
    result.setResponsiblePersonId(Integer.valueOf(definition.getResponsibleId()));
    result.setPiquetGSM(definition.getPiquetGSM());
