...
public class ACSJMSMessage implements Message {
	...
	public ACSJMSMessage(ACSJMSMessageEntity message, ContainerServicesBase cs) {
		...
		this.entity = message;
		if (!this.entity.destination.isEmpty())
			this.destination = new ACSJMSTopic(this.entity.destination);
	...
	/* (non-Javadoc)
	 * @see jakarta.jms.Message#getBody(Class<T> c)
	 */
	...
	public void setJMSDestination(Destination destination) throws JMSException {
		...
		if (destination instanceof ACSJMSTopic)
			this.entity.destination = ((ACSJMSTopic) destination).getTopicName();
	}
	...
	public long getJMSDeliveryTime() throws JMSException {
		throw new UnsupportedOperationException();
		//return this.entity.delivery_time;
	}
	...
	public void setJMSDeliveryTime(long deliveryTime) throws JMSException {
		throw new UnsupportedOperationException();
		//this.entity.delivery_time = deliveryTime;
	}
	...
	public Object getObjectProperty(String name) throws JMSException {
		...
		if(idx == -1) {
			...
			switch (this.entity.properties[idx].property_value.type().kind().value()) {
				case TCKind._tk_boolean:
					return this.entity.properties[idx].property_value.extract_boolean();
				case TCKind._tk_long:
					return this.entity.properties[idx].property_value.extract_long();
				case TCKind._tk_string:
					return this.entity.properties[idx].property_value.extract_string();
				case TCKind._tk_longlong:
					return this.entity.properties[idx].property_value.extract_longlong();
				case TCKind._tk_short:
					return this.entity.properties[idx].property_value.extract_short();
				case TCKind._tk_octet:
					return this.entity.properties[idx].property_value.extract_octet();
				case TCKind._tk_double:
					return this.entity.properties[idx].property_value.extract_boolean();
				case TCKind._tk_objref:
					return this.entity.properties[idx].property_value.extract_Object();
				default:
					throw new UnsupportedOperationException();
			}
		}
	...
	public Enumeration getPropertyNames() throws JMSException {
		...
		for(int i = 0; i < this.entity.properties.length; ++i) {
			props.add(this.entity.properties[i].property_name);
		}
		return props.elements();
	}

	/* (non-Javadoc)
	 * @see jakarta.jms.Message#isBodyAssignableTo(Class c)
	 */
	public boolean isBodyAssignableTo(Class c) throws JMSException {
		return c.isInstance(getBody(c));
	}
