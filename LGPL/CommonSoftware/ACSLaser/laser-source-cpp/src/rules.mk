...
# laserSourceAcsSpecific library is for the ACS-(CERN-style)-specific code not to be reused by 3rd parties
laserSourceAcsSpecific_OBJECTS:=CERNASIMessage CERNAlarmSystemInterfaceFactory \
				CERNAlarmSystemInterfaceProxy  AcsAlarmPublisher \
				AlarmSupplier
