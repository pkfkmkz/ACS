...
void sendAlarm(
	...
	std::shared_ptr<acsalarm::FaultState> fltstate = ACSAlarmSystemInterfaceFactory::createFaultState(ff, fm, fc);
...
int main(int argc, char *argv[])
{
    ...
    // create the AlarmSystemInterface
 	std::shared_ptr<acsalarm::AlarmSystemInterface> alarmSource(ACSAlarmSystemInterfaceFactory::createSource());
 	...
 	std::shared_ptr<acsalarm::AlarmSystemInterface> tstSource(ACSAlarmSystemInterfaceFactory::createSource());
