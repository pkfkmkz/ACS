...
public class ACSResponsiblePersonDAOImpl implements ResponsiblePersonDAO
{
	...
	static {
		...
		theResponsiblePerson.setResponsibleId(Integer.valueOf(1));
	}
...
/*
			...
			if (n.getNodeType() == Node.ELEMENT_NODE) {
				if ("eMail".equals(n.getNodeName())) {
					...
					try {
						...
						responsibleId = Integer.valueOf(tmpi);
	...
	public ResponsiblePerson[] findAllResponsiblePersons()
	{
		...
		for (int a=0; a<l; a++) {
			ResponsiblePerson thisOne=getResponsiblePerson(Integer.valueOf(a));
			if (thisOne==null) { 
