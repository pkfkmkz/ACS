...
if options.timeout!=None:
    temp_any = any.to_any(int(options.timeout))
...
if options.max_events_per_consumer!=None:
    temp_any = any.to_any(int(options.max_events_per_consumer))
