...
std::string execute_process(std::string &cmd)
{
...
::CORBA::Long ACSContainerHandlerImpl::get_container_stacktrace(
                                        const char * container_name,
                                        const char * container_type,
                                        ::CORBA::String_out output)
{
    std::string cmd = "acsdaemonContainerUtil ";
    cmd += "stack ";
    cmd += container_type;
    cmd += " ";
    cmd += container_name;
    std::string ret = execute_process(cmd);
    output = ::CORBA::string_dup(ret.c_str());
    return 0;
}


::CORBA::Long ACSContainerHandlerImpl::get_container_coredump(
                                        const char * container_name,
                                        const char * container_type,
                                        ::CORBA::String_out output)
{
