...
class ServiceController {
  ...
  public:
    ...
    void restart();
    bool start(acsdaemon::DaemonCallback_ptr callback = NULL);
    void stop(acsdaemon::DaemonCallback_ptr callback = NULL);
...
class ACSDaemonContext {
  ...
  public:
    ...
    void processRequest(ACSServiceRequestTarget target, ACSServiceRequestType type, ACSServiceRequestDescription *desc, acsdaemon::DaemonCallback_ptr callback = NULL);
