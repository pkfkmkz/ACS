...
*
* "@(#) $Id: acsACSLogServiceImpHandlerImpl.h,v 1.1 2008/10/27 21:11:23 msekoran Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
...
class ACSLogServiceImpHandlerImpl : public ACSImpBaseHandlerImpl<ACSLogServiceImpHandlerImpl>, public POA_acsdaemon::ACSLogImp {

public:

    ACSLogServiceImpHandlerImpl() : ACSImpBaseHandlerImpl<ACSLogServiceImpHandlerImpl>(ACS_LOG_SERVICE) {}
