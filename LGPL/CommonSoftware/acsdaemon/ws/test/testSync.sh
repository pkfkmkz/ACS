...
acsdaemonStartContainer --synchronous -t py -m fortranContainer -c CONTROL/AMBSOCKETSERVER/pyCasaContainer -i 0 &> syncStartpyCasaContainer.log
if [ $? -ne 0 ]; then
...
if [ -n "$CASA_DUMMY_CONTAINER_PID" ]; then
