...
namespace Parameters {
	...
	{    
	  public:
	     ...
	     * Constructor.
	     */
	    StringParamDef(const std::string & nameVal, const std::string & helpVal, const std::string & promptVal, 
	       bool isRequired, std::shared_ptr<std::string> defaultVal, std::shared_ptr<std::vector<std::string>> validVals);
	     ...
	     * @return the default value as an shared_ptr to a string
	     * if defined for this pdef, then the shared_ptr will 
	     * point to something meaningful, else null.
	     */
	    std::shared_ptr<std::string> getDefault();
	    
	    /*
	     * Accessor for the valid values.
	     * @return the valid values as an shared_ptr to a vector of strings
	     * if defined for this pdef, then the shared_ptr will 
	     * point to something meaningful, else null.
	     */
	    std::shared_ptr<std::vector<std::string>> getValidValues();
	  ...
	  private:
	    std::string defaultValue_m;
	    std::vector<std::string> validValues_m;
	    bool hasDefault_m;
