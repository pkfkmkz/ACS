...
namespace Parameters {
	...
	{    
	  public:
	     ...
	     * Constructor.
	     */
	    IntArrayParamDef(const std::string & paramName, const std::string & helpText, const std::string & promptText, 
	       bool requiredBoolVal, std::shared_ptr<std::string> unitsText, std::shared_ptr<int> maxLen, std::shared_ptr<std::vector<int>> defaultVals);
	     ...
	     * @return the maxlen value as an shared_ptr to int
	     * if defined for this pdef, then the shared_ptr will 
	     * point to something meaningful, else null.
	     */
	     ...
	     * @return the default value as an shared_ptr to a vector of int.
	     * if defined for this pdef, then the shared_ptr will 
	     * point to something meaningful, else null.
	     */
	    std::shared_ptr<std::vector<int>> getDefaultValues();
	  ...
	  private:
	    std::vector<int> defaultValues_m;
	    int maxLen_m;
	    std::string units_m;
