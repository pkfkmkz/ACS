...
namespace Parameters {
	...
	{    
	  public:
	     ...
	     * Constructor.
	     */
	    DoubleArrayParamDef(const std::string & paramName, const std::string & helpText, const std::string & promptText, 
	       bool requiredBoolVal, std::shared_ptr<std::string> unitsText, std::shared_ptr<int> maxLen, std::shared_ptr<std::vector<double>> defaultVals);
	     ...
	     * @return the units as an  shared_ptr to a string; 
	     * if units have been defined for this pdef, then the shared_ptr will 
	     ...
	     * if maxLen has been defined for this pdef, then the shared_ptr will 
	     * point to an int of the maxLen, else it will pt to a null. 
	     */
	    std::shared_ptr<int> getMaxLen();

	    /*
	     * Accessor for the default value.
	     * @return the default value as a vector of double
	     * if default values have been defined for this pdef, then the shared_ptr will 
	     * point to a vector of doubles of the defaultvalues, else it will pt to a null. 
	     */
	    std::shared_ptr<std::vector<double>> getDefaultValues();
	  ...
	  private:
	    std::vector<double> defaultValues_m;
	    int maxLen_m;
	    std::string units_m;
