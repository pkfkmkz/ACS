...
void ParamSetDef::handleIntParamDef(DOMElement *paramElem) 
{
	...
	shared_ptr< string > strDefaultText;
	...
	shared_ptr< vector<int> > validVals;
...
void ParamSetDef::handleIntArrayParamDef(DOMElement *paramElem) 
{
	...
	shared_ptr< vector<int> > defaultVals(new vector<int>);
...
void ParamSetDef::handleDoubleParamDef(DOMElement *paramElem) 
{
	...
	// 5. get the default value
	DOMNodeList *defaultNodes = paramElem->getElementsByTagName(DEFAULT_TAG_NAME);
	shared_ptr< double > defaultValue;
	if(NULL != defaultNodes) {
		DOMNode *defaultNode = defaultNodes->item(0);
		if(NULL != defaultNode) {
			DOMNode *defaultTextNode = defaultNode->getFirstChild();
	...
	// 10. get the valid values
	shared_ptr< vector<double> > validVals;
	DOMNodeList *validValNodes = paramElem->getElementsByTagName(VALID_VALUES_TAG_NAME);
	if(0 != validValNodes->getLength()) {
...
void ParamSetDef::handleDoubleArrayParamDef(DOMElement *paramElem) 
{
	...
	// 7. get the default value(s)
	shared_ptr< vector<double> > defaultVals(new vector<double>);
	DOMNodeList *defaultValNodes = paramElem->getElementsByTagName(DEFAULT_TAG_NAME);
	for (unsigned int i = 0; i < defaultValNodes->getLength(); i++) {
		DOMNode *defaultValNode = defaultValNodes->item(i);
		DOMNode *defaultValTextNode = defaultValNode->getFirstChild();
...
void ParamSetDef::handleStringParamDef(DOMElement *paramElem) 
{
	...
	// 5. get the default value
	DOMNodeList *defaultNodes = paramElem->getElementsByTagName(DEFAULT_TAG_NAME);
	shared_ptr < string > defaultString;
	if(NULL != defaultNodes) {
		DOMNode *defaultNode = defaultNodes->item(0);
		if(NULL != defaultNode) {
			DOMNode *defaultTextNode = defaultNode->getFirstChild();
	...
	shared_ptr< vector<string> > validVals;
	DOMNodeList *validValNodes = paramElem->getElementsByTagName(VALID_VALUES_TAG_NAME);
	if(0 != validValNodes->getLength()) {
...
void ParamSetDef::handleStringArrayParamDef(DOMElement *paramElem) 
{
	...
	shared_ptr< vector<string> > defaultVals(new vector<string>);
	DOMNodeList *defaultValNodes = paramElem->getElementsByTagName(DEFAULT_TAG_NAME);
	for (unsigned int i = 0; i < defaultValNodes->getLength(); i++) {
		DOMNode *defaultValNode = defaultValNodes->item(i);
		DOMNode *defaultValTextNode = defaultValNode->getFirstChild();
 ...
 */
shared_ptr< vector<BoolParamDef> > ParamSetDef::getBoolParamDefs()
{
	shared_ptr< vector<BoolParamDef> > retVal(new vector<BoolParamDef>);
 ...
 */
shared_ptr< vector<IntParamDef> > ParamSetDef::getIntParamDefs()
{
	shared_ptr< vector<IntParamDef> > retVal(new vector<IntParamDef>);
 ...
 */
shared_ptr< vector<StringParamDef> > ParamSetDef::getStringParamDefs()
{
	shared_ptr< vector<StringParamDef> > retVal(new vector<StringParamDef>);
 ...
 */
shared_ptr< vector<DoubleParamDef> > ParamSetDef::getDoubleParamDefs()
{
	shared_ptr< vector<DoubleParamDef> > retVal(new vector<DoubleParamDef>);
 ...
 */
shared_ptr< vector<IntArrayParamDef> > ParamSetDef::getIntArrayParamDefs()
{
	shared_ptr< vector<IntArrayParamDef> > retVal(new vector<IntArrayParamDef>);
 ...
 */
shared_ptr< vector<DoubleArrayParamDef> > ParamSetDef::getDoubleArrayParamDefs()
{
	shared_ptr< vector<DoubleArrayParamDef> > retVal(new vector<DoubleArrayParamDef>);
 ...
 */
shared_ptr< vector<StringArrayParamDef> > ParamSetDef::getStringArrayParamDefs()
{
	shared_ptr< vector<StringArrayParamDef> > retVal(new vector<StringArrayParamDef>);
 ...
 */
void ParamSetDef::setSchemaLocation(DOMLSParser * parser)
{
