...
DoubleArrayParamDef::DoubleArrayParamDef(const string & paramName, const string & helpText, const string & promptText, 
	bool requiredBoolVal, shared_ptr< string > unitsText, shared_ptr< int > maxLenVal, shared_ptr< vector < double > > defaultVals): 
 ...
 */
shared_ptr<string> DoubleArrayParamDef::getUnits()
{
 ...
 */
shared_ptr<int> DoubleArrayParamDef::getMaxLen()
{
 ...
 */
shared_ptr< vector<double> > DoubleArrayParamDef::getDefaultValues()
{
