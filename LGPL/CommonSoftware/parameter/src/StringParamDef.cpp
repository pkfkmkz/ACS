...
StringParamDef::StringParamDef(const string & nameVal, const string & helpVal, const string & promptVal, 
	bool isRequired, shared_ptr< string > defaultVal, shared_ptr< vector < string > > validVals): 
 ...
 */
shared_ptr<string> StringParamDef::getDefault()
{
 ...
 */
shared_ptr< vector< string > > StringParamDef::getValidValues() 
{
