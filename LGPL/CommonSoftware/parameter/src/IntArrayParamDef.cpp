...
IntArrayParamDef::IntArrayParamDef(const string & paramName, const string & helpText, const string & promptText, 
	bool requiredBoolVal, shared_ptr< string > unitsText, shared_ptr< int > maxLenVal, shared_ptr< vector < int > > defaultVals):
 ...
 */
shared_ptr<string> IntArrayParamDef::getUnits()
{
 ...
 */
shared_ptr<int> IntArrayParamDef::getMaxLen()
{
 ...
 */
shared_ptr< vector<int> > IntArrayParamDef::getDefaultValues()
{
