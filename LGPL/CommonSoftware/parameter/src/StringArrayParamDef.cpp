...
StringArrayParamDef::StringArrayParamDef(const string & paramName, const string & helpText, const string & promptText, 
	bool requiredBoolVal, shared_ptr< int > maxLenVal, shared_ptr< vector < string > > defaultVals): 
 ...
 */
shared_ptr<int> StringArrayParamDef::getMaxLen()
{
 ...
 */
shared_ptr< vector<string> > StringArrayParamDef::getDefaultValues()
{
	shared_ptr<vector <string> > retVal;
