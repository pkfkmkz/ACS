...
DoubleParamDef::DoubleParamDef(const string & nameVal, const string & helpVal, const string & promptVal, bool isRequired, 
	shared_ptr< double > defaultVal, shared_ptr< string > strDefault, shared_ptr< string > unitsVal, 
	shared_ptr< double > maxVal, shared_ptr< double > minVal, shared_ptr< vector<double> > validVals): 
 ...
 */
shared_ptr<double> DoubleParamDef::getDefault()
{
	shared_ptr<double> retVal;
 ...
 */
shared_ptr<string> DoubleParamDef::getStringDefault()
{
	shared_ptr<string> retVal;
 ...
 */
shared_ptr< string > DoubleParamDef::getUnits()
{
	shared_ptr<string> retVal;
	if(true == getHasUnits()) {
 ...
 */
shared_ptr<double> DoubleParamDef::getMax()
{
	shared_ptr<double> retVal;
	if(true == getHasMax()) {
 ...
 */
shared_ptr<double> DoubleParamDef::getMin()
{
	shared_ptr<double> retVal;
	if(true == getHasMin()) {
 ...
 */
shared_ptr< vector< double > > DoubleParamDef::getValidValues()
{
	shared_ptr<vector <double> > retVal;
