...
IntParamDef::IntParamDef(const string & nameVal, const string & helpVal, const string & promptVal, 
	bool isRequired, shared_ptr< int > defaultVal, shared_ptr< string > strDefault, shared_ptr< string > unitsVal, 
	shared_ptr< int > maxVal, shared_ptr< int > minVal, shared_ptr< vector<int> > validVals):
 ...
 */
shared_ptr< int > IntParamDef::getDefault()
{
	shared_ptr<int> retVal;
 ...
 * @return the default value as a int ptr.
 */
shared_ptr< string > IntParamDef::getStringDefault()
{
 ...
 */
shared_ptr< string > IntParamDef::getUnits()
{
	shared_ptr<string> retVal;
	if(true == getHasUnits()) {
 ...
 */
shared_ptr< int > IntParamDef::getMax()
{
	shared_ptr<int> retVal;
	if(true == getHasMax()) {
 ...
 */
shared_ptr< int > IntParamDef::getMin()
{
	shared_ptr<int> retVal;
	if(true == getHasMin()) {
 ...
 */
shared_ptr< vector<int> > IntParamDef::getValidValues()
{
	shared_ptr<vector <int> > retVal;
