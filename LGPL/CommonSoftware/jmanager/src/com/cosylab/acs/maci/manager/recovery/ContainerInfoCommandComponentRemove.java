 ...
 */
public class ContainerInfoCommandComponentRemove implements TransactionWithQuery<ManagerImpl, Serializable> {
	 ...
	 */
	public ContainerInfoCommandComponentRemove(int handle, int cobHandle) {
		super();
		this.handle = handle;
