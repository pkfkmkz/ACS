 ...
 */
public class AdministratorCommandAllocate implements TransactionWithQuery<ManagerImpl, Serializable> {
	...
	public Serializable executeAndQuery(ManagerImpl system, Date ignored) {
		return Integer.valueOf(system.getAdministrators().allocate());
	}
