 ...
 */
public class ComponentInfoCommandComponentRemove implements TransactionWithQuery<ManagerImpl, Serializable> {
	 ...
	 */
	public ComponentInfoCommandComponentRemove(int hid, int handle) {
		super();
		this.hid = hid;
		this.handle = handle;
	}
