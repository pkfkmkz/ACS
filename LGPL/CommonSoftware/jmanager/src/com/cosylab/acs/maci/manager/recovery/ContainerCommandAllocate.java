 ...
 */
public class ContainerCommandAllocate implements TransactionWithQuery<ManagerImpl, Serializable> {

	/**
	 * Constructor for COBCommandAckAlloc.
	 */
	public ContainerCommandAllocate() {
		super();
	}
	...
	public Serializable executeAndQuery(ManagerImpl system, Date ignored) {
		return Integer.valueOf(system.getContainers().allocate());
	}
