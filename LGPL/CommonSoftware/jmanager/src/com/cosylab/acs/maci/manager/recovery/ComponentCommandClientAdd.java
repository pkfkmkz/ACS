 ...
 */
public class ComponentCommandClientAdd implements TransactionWithQuery<ManagerImpl, Serializable> {
	 ...
	 */
	public ComponentCommandClientAdd(int handle, int clientHandle) {
		super();
		this.handle = handle;
