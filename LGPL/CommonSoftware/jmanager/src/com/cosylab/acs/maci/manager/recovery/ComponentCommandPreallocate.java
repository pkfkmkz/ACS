 ...
 */
public class ComponentCommandPreallocate implements TransactionWithQuery<ManagerImpl, Serializable> {

	/**
	 * Constructor for COBCommandAckAlloc.
	 */
	public ComponentCommandPreallocate() {
		super();
	}
	...
	public Serializable executeAndQuery(ManagerImpl system, Date ignored) {
		return Integer.valueOf(system.getComponents().preallocate());
	}
