...
{
    return maci::SmartPtr<T>(maci::make_shared_component(this, true, this->getComponent<T>(name)));
}//getComponentSmartPtr

template <typename T>
maci::SmartPtr<T> maci::ContainerServices::getComponentNonStickySmartPtr(const char *name)
{ 
    return maci::SmartPtr<T>(maci::make_shared_component(this, false, this->getComponentNonSticky<T>(name)));
...
{
    return maci::SmartPtr<T>(maci::make_shared_component(this, true, this->getDynamicComponent<T>(compSpec, markAsDefault)));
...
{
    return maci::SmartPtr<T>(maci::make_shared_component(this, true, this->getCollocatedComponent<T>(compSpec, markAsDefault, targetComponent)));
