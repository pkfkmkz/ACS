...
public class Executor {
   ...
   static public void localOutProc(String command, boolean foreground, long maxExecutionTime, String endMark, NativeCommand.Listener listener) throws Throwable {
      localOutProc(command, null, foreground, maxExecutionTime, endMark, listener);
   }

   static public void localOutProc(String command, String environ, boolean foreground, long maxExecutionTime, String endMark, NativeCommand.Listener listener) throws Throwable {
   ...
   static public Exception remoteDaemonForContainersStacktraceOrCoredump (String host, int instance, boolean stacktraceCoredump, String contName, String contType, String[] contTypeMods, String cmdFlags, NativeCommand.Listener listener) {
	   	if (listener != null) {
	   		listener.stdoutWritten(null, "\nIn daemon mode, output cannot be displayed.\n" +
	   				"See logs in <daemon-owner>/.acs/commandcenter on host "+host+"\n");
	   	}
