...
public class CastorUnmarshalMapper extends TypeMapper
{
		...
		ComponentInvocationHandler invHandler)
	{
		...
		if (XmlEntityStruct.class.isAssignableFrom(oldObjClass))
		{
			...
			XMLClassDescriptorResolver clDescRes = (XMLClassDescriptorResolver) ClassDescriptorResolverFactory.createClassDescriptorResolver(BindingType.XML);
			clDescRes.setUseIntrospection(false);
			try {
