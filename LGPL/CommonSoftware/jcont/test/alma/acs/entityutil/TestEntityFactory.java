...
class TestEntityFactory
{
	ObsProject getObsProject() 
	{
		...
		entity.setEntityId("uid://A001/X1230000000000000/X00000001");
		entity.setSchemaVersion("1.0"); 
		
		ObsProposalRefT ref = new ObsProposalRefT();
		proj.setObsProposalRef(ref);
		
		ref.setEntityId("uid://A001/X1230000000000000/X00000002");
		...
		schedBlockRef1.setEntityId("uid://A001/X1230000000000000/X00000003");
	...
	ObsProposal getObsProposal() 
	{
		...
		entity.setEntityId("uid://A001/X1230000000000000/X00000002");

		ObsProjectRefT ref = new ObsProjectRefT();
		ref.setEntityId("uid://A001/X1230000000000000/X00000001");
