...
public final class LogEntryXML implements ILogEntry
{
	...
	private void initAttributes(Node log) throws DOMException
	{
		...
		if (attr != null)
			setField(LogField.LINE, Integer.valueOf(attr.getNodeValue()));
		...
		if (attr != null)
			setField(LogField.STACKLEVEL, Integer.valueOf(attr.getNodeValue()));
		...
		if (attr != null)
			setField(LogField.PRIORITY, Integer.valueOf(attr.getNodeValue()));
