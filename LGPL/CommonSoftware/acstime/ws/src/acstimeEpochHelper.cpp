...
EpochHelper::m_toValue(CORBA::Boolean dayOfYearSet)
{
    ...
    // ICT-7475: Fix the 24:00:00 time representation. ISO-8601 indicates it should be accepted, and
    //      treated as the same instant as the next day's first second.
    if ( (0 == microSecond_m) && (0 == second_m) && (0 == minute_m) && (24 == hour_m))
    {
        // The second 24:00:00 is the same as the second of the next day 00:00:00. So we change the hour
        hour_m = 0;
        // And we move forward one day
    ...
    // TODO: This does not correctly handle leap seconds. The presence of a 60th second is not detected.
