...
{    
	...
	///////////
	cout << "New test for ICT-7475: 24:00:00 needs to be considered a normal case" << endl << endl;
    {
        delete e1;
        e1 = new EpochHelper();
        e1->fromString(acstime::TSArray, "2016-05-27T24:00:00.000000");
        cout << "Epoch value:" << e1->value().value << endl;
    }
