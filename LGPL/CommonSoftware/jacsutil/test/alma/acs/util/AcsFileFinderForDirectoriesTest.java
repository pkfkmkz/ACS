...
public class AcsFileFinderForDirectoriesTest
{
	...
	public void testEmptyProperties() {
		...
		//SEARCHPATH unset
		System.clearProperty(AcsFileFinderForDirectories.SEARCHPATH_PROPERTYNAME);
		fileFinder = new AcsFileFinderForDirectories(logger, true);

		//ACSDATA DIR unset
		System.setProperty(AcsFileFinderForDirectories.SEARCHPATH_PROPERTYNAME, "/test1:/test2");
		System.clearProperty(AcsFileFinderForDirectories.ACSDATA_PATH_PROPERTYNAME);
		fileFinder = new AcsFileFinderForDirectories(logger, true);

		//Both properties unset
		System.clearProperty(AcsFileFinderForDirectories.SEARCHPATH_PROPERTYNAME);
		fileFinder = new AcsFileFinderForDirectories(logger, true);
	}
}
