 ...
 * @since   2016.6
 */
class TestJarOrderOptimizer {
	public TestJarOrderOptimizer() {
		JarOrderOptimizer jarOrderOptimizer = new JarOrderOptimizer(true);
	}
	
	public static void main(String[] args) {
		System.out.println("TestJarOptmi called with #args=" + args.length);
		TestJarOrderOptimizer testOptimizer = new TestJarOrderOptimizer();
		System.out.println("The AcsTopsJars.txt file has been read and optimized");
	}
}
