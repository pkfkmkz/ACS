...
class PyBaciTest(CharacteristicComponent,
    ...
    def initialize(self):
        ...
        addProperty(self, "uLongROProp")
        addProperty(self, "uLongRWProp")
        ...
        addProperty(self, "longLongSeqROProp")
        addProperty(self, "longLongSeqRWProp")

        addProperty(self, "uLongSeqROProp")
        addProperty(self, "uLongSeqRWProp")

        addProperty(self, "uLongLongSeqROProp")
        addProperty(self, "uLongLongSeqRWProp")
