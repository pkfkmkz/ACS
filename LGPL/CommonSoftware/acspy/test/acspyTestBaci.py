...
from   Acspy.Common.Callbacks import CBlongLongSeq
from   Acspy.Common.Callbacks import CBuLong
from   Acspy.Common.Callbacks import CBuLongSeq
from   Acspy.Common.Callbacks import CBuLongLong
from   Acspy.Common.Callbacks import CBuLongLongSeq
...
def testBasicROProperty(propRef, cbRef):
    ...
    print("min_timer_trigger:", propRef._get_min_timer_trigger())
    ...
    print("create_postponed_monitor:", propRef.create_postponed_monitor(10000000, cbRef, DESC))
    #print ":", propRef.
#------------------------------------------------------------------------------
...
print("----------------------------------------------------------------")
testComplexROProperty(pybaci._get_uLongROProp(), CBuLong()._this())
print("----------------------------------------------------------------")
...
print("----------------------------------------------------------------")
testComplexROProperty(pybaci._get_longLongSeqROProp(), CBlongLongSeq()._this())
print("----------------------------------------------------------------")
testComplexROProperty(pybaci._get_uLongSeqROProp(), CBuLongSeq()._this())
print("----------------------------------------------------------------")
testComplexROProperty(pybaci._get_uLongLongSeqROProp(), CBuLongLongSeq()._this())
print("----------------------------------------------------------------")
print("----------------------------------------------------------------")
...
print("----------------------------------------------------------------")
testComplexRWProperty(pybaci._get_longLongRWProp(), CBlongLong()._this(), 1234)
print("----------------------------------------------------------------")
testComplexRWProperty(pybaci._get_uLongRWProp(), CBuLong()._this(), 12345)
print("----------------------------------------------------------------")
testComplexRWProperty(pybaci._get_uLongLongRWProp(), CBuLongLong()._this(), 12345)
print("----------------------------------------------------------------")
...
print("----------------------------------------------------------------")
testComplexRWProperty(pybaci._get_longLongSeqRWProp(), CBlongLongSeq()._this(), [10, 20, 30])
print("----------------------------------------------------------------")
testComplexRWProperty(pybaci._get_uLongSeqRWProp(), CBuLongSeq()._this(), [10, 20, 30])
print("----------------------------------------------------------------")
testComplexRWProperty(pybaci._get_uLongLongSeqRWProp(), CBuLongLongSeq()._this(), [10, 20, 30])
print("----------------------------------------------------------------")
print("----------------------------------------------------------------")
