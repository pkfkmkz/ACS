...
class TestGetLogger(unittest.TestCase):
    ...
    @mock.patch.object(CS, 'getLogger')
    @mock.patch.object(CS, 'CDBaccess')
...
class TestGetComponent(unittest.TestCase):
    ...
    @mock.patch.object(CS, 'getManager')
    @mock.patch.object(CS, 'CDBaccess')
    @mock.patch.object(CS.ContainerServices,
    ...
    @mock.patch.object(CS.ContainerServices, 'getDefaultComponent')
    @mock.patch.object(CS, 'CDBaccess')
    ...
    @mock.patch.object(CS.ContainerServices, 'getDynamicComponent')
    @mock.patch.object(CS, 'CDBaccess')
...
class TestImportComponentStubs(unittest.TestCase):
    ...
    @mock.patch.object(CS.ContainerServices, 'availableComponents')
    @mock.patch.object(CS, 'CDBaccess')
    ...
    def test_known_type_unknown_class(self, cdbaccessmock):
        sys.modules['MockModule'] = types.ModuleType('MockModule')
        loggermock = mock.Mock(spec=Acspy.Common.Log.Logger)
        containerservices = CS.ContainerServices()
        containerservices._ContainerServices__logger = loggermock
