...
def timestamp_builder():
    ...
    mockts.value = 134831582610597120
    return mockts
...
class TestBaseClient(unittest.TestCase):
    ...
    @mock.patch.object(Acspy.Clients.BaseClient, 'getLogger')
    @mock.patch.object(Acspy.Clients.BaseClient, 'getManager',
                       manager_login_value_builder)
    @mock.patch.object(Acspy.Clients.BaseClient.BaseClient, 'getMyCorbaRef')
...
#         self.assertEqual('Foo', bc._get_name())
    ...
    @mock.patch.object(Acspy.Clients.BaseClient, 'getLogger', logger_builder)
    @mock.patch.object(Acspy.Clients.BaseClient, 'getManager',
                       manager_login_value_builder)
    @mock.patch.object(Acspy.Clients.BaseClient.BaseClient, 'getMyCorbaRef')
    ...
    @mock.patch.object(Acspy.Clients.BaseClient, 'getManager',
                       manager_logout_exception_builder)
    @mock.patch.object(Acspy.Clients.BaseClient.BaseClient, 'getMyCorbaRef')
    @mock.patch.object(Acspy.Clients.BaseClient, 'getTimeStamp', timestamp_builder)
