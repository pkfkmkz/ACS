...
s/\(timeStamp\|type\|code\)=[0-9]\+L*/\1=XXXX/g
s/- [^ ]\+: \(CORBA\.[A-Z_]\+\)(\([^ ]\+\), \(CORBA\.COMPLETED_[A-Z]\+\))/- omniORB.CORBA._omni_sys_exc: \1(\2, \3)/
s/ImportError: No module named \([^ ]*\)/ModuleNotFoundError: No module named '\1'/
s/ImportError: reload(): module \([^ ]*\) not in sys.modules/ImportError: module \1 not in sys.modules/
s/IOError: \[Errno 2\] No such file or directory:/FileNotFoundError: [Errno 2] No such file or directory:/
s/ ComponentLifecycleException: / Acspy.Servants.ComponentLifecycle.ComponentLifecycleException: /
s/(0L,/(0,/
