...
class TestCommonNC(unittest.TestCase):
    ...
    @mock.patch.object(Acspy.Nc.CommonNC,'cdb_channel_config_exists', mockNotExists)
    ...
    @mock.patch.object(Acspy.Nc.CommonNC,'cdb_channel_config_exists', mockExists)
    @mock.patch.object(Acspy.Nc.CommonNC,'get_channel_admin_props', mockProps)
    ...
    @mock.patch.object(Acspy.Nc.CommonNC,'cdb_channel_config_exists', mockExists)
    @mock.patch.object(Acspy.Nc.CommonNC,'get_channel_qofs_props', mockProps)
    ...
    def test_createNotificationChannel_missingFactory(self):
        ...
        except CORBAProblemExImpl as e:
    ...
    @mock.patch.object(Acspy.Nc.CommonNC,'get_notification_service_mapping', mock.Mock())
    ...
    @mock.patch.object(Acspy.Nc.CommonNC, 'NameTree', mockNameTree)
    ...
    @mock.patch.object(mockNameTree, 'nameTree', nameTree_side_effect)
    @mock.patch.object(Acspy.Nc.CommonNC, 'NameTree', mockNameTree)
