...
class TestSimpleClient(unittest.TestCase):
    ...
    @mock.patch.object(Acspy.Util.ACSCorba, 'getManager',
    ...
    @mock.patch.object(Acspy.Servants.ContainerServices, 'CDBaccess')
    @mock.patch.object(Acspy.Common.Log, 'getLogger')
