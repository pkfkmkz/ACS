...
class ImportComponentStubsCheck(unittest.TestCase):
    ...
    def testGetManager(self):
        ...
        self.assertEqual([], Acspy.Servants.ContainerServices.getManager().get_component_info())

    def testGetLogger(self):
        """Mock Logger recorded correct log message"""
        self.assertEqual(None, Acspy.Servants.ContainerServices.getLogger("a").logWarning("Spoon!"))
        self.assertEqual("Spoon!", mockLogger.mockGetNamedCalls("logWarning")[-1].getParam(0))
    ...
    def testUnknownComponent(self):
        ...
        self.assertEqual("Unable to import 'Foo' component's module: Component type unavailable!",
    ...
    def testImportFailure(self):
        ...
        self.assertEqual("Unable to import 'Foo' component's module: No module named Foo",
                          mockLogger.mockGetNamedCalls("logWarning")[-1].getParam(0))
