#ifndef _acsnc_rtsupplier_comp_impl_h_
#define _acsnc_rtsupplier_comp_impl_h_
/*******************************************************************************
...
*
* "@(#) $Id: acsncRTSupplierCompImpl.h,v 1.6 2008/10/01 03:14:56 cparedes Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
 ...
 */
class RTSupplierCompImpl: public virtual acscomponent::ACSComponentImpl,
	      public virtual POA_demo::SupplierComp
{
  public:
     ...
     */
    RTSupplierCompImpl(const ACE_CString& name,
		       maci::ContainerServices *);
    
    /**
     * Destructor
     */
    virtual ~RTSupplierCompImpl();
