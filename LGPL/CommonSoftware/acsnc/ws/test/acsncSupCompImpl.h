#ifndef _acsnc_sup_comp_impl_h_
#define _acsnc_sup_comp_impl_h_
/*******************************************************************************
...
*
* "@(#) $Id: acsncSupCompImpl.h,v 1.8 2006/09/01 02:20:54 cparedes Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
 ...
 */
class SupCompImpl: public virtual acscomponent::ACSComponentImpl,
			public virtual POA_demo::SupComp
{
  public:
    /* ----------------------------------------------------------------*/
    /**
     ...
     */
    SupCompImpl(const ACE_CString& name,
