...
namespace nc {
	...
	using ArchiveHandlerSmartPtr = acsutil::SmartPtr<ArchiveHandler>;
	 ...
	 */
	ArchiveConsumer(ArchiveHandler* handler) : ArchiveConsumer(ArchiveHandlerSmartPtr(handler)) {}
	 ...
	 *                archive event is received.
	 */
	ArchiveConsumer(CORBA::ORB_ptr orb_p, ArchiveHandler* handler) : ArchiveConsumer(orb_p, ArchiveHandlerSmartPtr(handler)) {}
	 ...
	 * @htmlonly
	 ...
	 @endhtmlonly
	*/
	ArchiveConsumer(int argc, char *argv[], ArchiveHandler* handler) : ArchiveConsumer(argc, argv, ArchiveHandlerSmartPtr(handler)) {}
