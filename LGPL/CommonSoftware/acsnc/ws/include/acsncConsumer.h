    ...
    protected virtual PortableServer::RefCountServantBase
{
  ...
  protected:
    ...
    /**
     * The list of events we are subscribed to. This is used in the reinit of the consumer
     */
    std::vector<std::string> subscriptions_m;
    ...
    /**
     * Mutex used to protect from reinitialization of the notification channel
     */
    ACE_RW_Thread_Mutex reinitThMutex_m;
