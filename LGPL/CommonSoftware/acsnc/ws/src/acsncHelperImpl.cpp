...
Helper::resolveNotificationFactory()
{
	...
	{
        ACS_SHORT_LOG((LM_DEBUG, "Helper::resolveNotificationFactory failed for the '%s' channel with a nil pointer!",
                   channelName_mp));
...
Helper::resolveNotifyChannel()
{
	...
	{
	ACS_SHORT_LOG((LM_DEBUG,"Helper::resolveNotifyChannel - this is expected when a channel is being created."));
