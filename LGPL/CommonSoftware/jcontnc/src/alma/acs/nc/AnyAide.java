...
class AnyAide {
	...
	public Object corbaAnyToObject(Any any) {
		...
		case org.omg.CORBA.TCKind._tk_double:
			// simple type in which we have an extract method
			returnValue = Double.valueOf(any.extract_double());
			break;

		case org.omg.CORBA.TCKind._tk_long:
			// simple type in which we have an extract method
			returnValue = Integer.valueOf(any.extract_long());
			break;
		...
		case org.omg.CORBA.TCKind._tk_ulong:
			// simple type in which we have an extract method
			returnValue = Integer.valueOf(any.extract_ulong());
			break;

		case org.omg.CORBA.TCKind._tk_longlong:
			// simple type in which we have an extract method
			returnValue = Long.valueOf(any.extract_longlong());
			break;

		case org.omg.CORBA.TCKind._tk_ulonglong:
			// simple type in which we have an extract method
			returnValue = Long.valueOf(any.extract_ulonglong());
			break;

		case org.omg.CORBA.TCKind._tk_float:
			// simple type in which we have an extract method
			returnValue = Float.valueOf(any.extract_float());
			break;
