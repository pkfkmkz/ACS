...
public class ArchiveSupplierTest extends ComponentClient
{
	...
	public void publish() throws Exception {
		m_supplier.publishEvent(Double.valueOf(3.14));
		m_supplier.publishEvent(Float.valueOf(3.1f));
		m_supplier.publishEvent(Long.valueOf(1));
		m_supplier.publishEvent(new String("2"));
		m_supplier.publishEvent(Long.valueOf(3));
		m_supplier.publishEvent(Long.valueOf(4));
