...
MCtestPropertiesComponentImpl::MCtestPropertiesComponentImpl(const ACE_CString& name,
	...
	m_longLongSeqROProp_p(0),
	m_uLongLongSeqROProp_p(0),
	...
	m_longLongSeqRWProp_p(0),
	m_uLongLongSeqRWProp_p(0),
	...
	m_EnumTestRWProp_p(0)
{
	...
	m_longLongSeqROVal.length(5);
	m_longLongSeqROVal[0] = -9223372036854775808LL; // Minimimum value of 64 bit integer.
	m_longLongSeqROVal[1] = -1;
	m_longLongSeqROVal[2] = 0;
	m_longLongSeqROVal[3] = 1;
	m_longLongSeqROVal[4] = 9223372036854775807LL;  // Maximum value of 64 bit integer.
	m_time14 = 134608945243381570;
	m_longLongSeqRODevIO = new MCtestDevIOSeqNoIncremental<ACS::longLongSeq>(m_longLongSeqROVal, m_time14);
	m_longLongSeqROProp_p = new ROlongLongSeq(name+":longLongSeqROProp", getComponent(), m_longLongSeqRODevIO);
	CHARACTERISTIC_COMPONENT_PROPERTY(longLongSeqROProp, m_longLongSeqROProp_p);
	m_uLongLongSeqROVal.length(3);
	m_uLongLongSeqROVal[0] = 0;
	m_uLongLongSeqROVal[1] = 1;
	m_uLongLongSeqROVal[2] = 18446744073709551615ULL; // Maximum value of 64 bit integer.
	m_time15 = 134608945243381570;
	m_uLongLongSeqRODevIO = new MCtestDevIOSeqNoIncremental<ACS::uLongLongSeq>(m_uLongLongSeqROVal, m_time15);
	m_uLongLongSeqROProp_p = new ROuLongLongSeq(name+":uLongLongSeqROProp", getComponent(), m_uLongLongSeqRODevIO);
	CHARACTERISTIC_COMPONENT_PROPERTY(uLongLongSeqROProp, m_uLongLongSeqROProp_p);
	...
	m_booleanSeqRODevIO = new MCtestDevIOSeqNoIncremental<ACS::booleanSeq>(m_booleanSeqROVal, m_time16);
	...
	m_EnumTestRODevIO = new MCtestDevIONoIncremental<EnumTest>(m_EnumTestROVal, m_time17);
	m_EnumTestROProp_p = new ROEnumImpl<ACS_ENUM_T(EnumTest), POA_TMCDB_Test::ROEnumTest>(name+":EnumTestROProp", getComponent(), m_EnumTestRODevIO);
	CHARACTERISTIC_COMPONENT_PROPERTY(EnumTestROProp, m_EnumTestROProp_p);
	//RW
	m_doubleRWVal = 0;
	m_time18 = 134608945243381570;
	m_doubleRWDevIO = new MCtestDevIONoIncremental<CORBA::Double>(m_doubleRWVal, m_time18);
	...
	m_floatRWDevIO = new MCtestDevIONoIncremental<CORBA::Float>(m_floatRWVal, m_time19);
	...
	m_longRWDevIO = new MCtestDevIONoIncremental<CORBA::Long>(m_longRWVal, m_time20);
	...
	m_uLongRWDevIO = new MCtestDevIONoIncremental<ACS::uLong>(m_uLongRWVal, m_time21);
	...
	m_patternRWDevIO = new MCtestDevIONoIncremental<ACS::pattern>(m_patternRWVal, m_time22);
	...
	m_stringRWDevIO = new MCtestDevIONoIncremental<ACE_CString>(m_stringRWVal, m_time23);
	...
	m_longLongRWDevIO = new MCtestDevIONoIncremental<ACS::longLong>(m_longLongRWVal, m_time24);
	...
	m_uLongLongRWDevIO = new MCtestDevIONoIncremental<ACS::uLongLong>(m_uLongLongRWVal, m_time25);
	...
	m_booleanRWDevIO = new MCtestDevIONoIncremental<CORBA::Boolean>(m_booleanRWVal, m_time26);
	...
	m_doubleSeqRWDevIO = new MCtestDevIOSeqNoIncremental<ACS::doubleSeq>(m_doubleSeqRWVal, m_time27);
	...
	m_floatSeqRWDevIO = new MCtestDevIOSeqNoIncremental<ACS::floatSeq>(m_floatSeqRWVal, m_time28);
	...
	m_longSeqRWDevIO = new MCtestDevIOSeqNoIncremental<ACS::longSeq>(m_longSeqRWVal, m_time29);
	...
	m_uLongSeqRWDevIO = new MCtestDevIOSeqNoIncremental<ACS::uLongSeq>(m_uLongSeqRWVal, m_time30);
	...
	m_longLongSeqRWVal.length(2);
	for(unsigned int i=0;i<m_longLongSeqRWVal.length();i++)
		m_longLongSeqRWVal[i]=0;
	m_time31 = 134608945243381570;
	m_longLongSeqRWDevIO = new MCtestDevIOSeqNoIncremental<ACS::longLongSeq>(m_longLongSeqRWVal, m_time31);
	m_longLongSeqRWProp_p = new RWlongLongSeq(name+":longLongSeqRWProp", getComponent(), m_longLongSeqRWDevIO);
	CHARACTERISTIC_COMPONENT_PROPERTY(longLongSeqRWProp, m_longLongSeqRWProp_p);
	m_uLongLongSeqRWVal.length(2);
	for(unsigned int i=0;i<m_uLongLongSeqRWVal.length();i++)
		m_uLongLongSeqRWVal[i]=0;
	m_time32 = 134608945243381570;
	m_uLongLongSeqRWDevIO = new MCtestDevIOSeqNoIncremental<ACS::uLongLongSeq>(m_uLongLongSeqRWVal, m_time32);
	m_uLongLongSeqRWProp_p = new RWuLongLongSeq(name+":uLongLongSeqRWProp", getComponent(), m_uLongLongSeqRWDevIO);
	CHARACTERISTIC_COMPONENT_PROPERTY(uLongLongSeqRWProp, m_uLongLongSeqRWProp_p);
	m_booleanSeqRWVal.length(2);
	for(unsigned int i=0;i<m_booleanSeqRWVal.length();i++)
		m_booleanSeqRWVal[i]=0;
	m_time33 = 134608945243381570;
	m_booleanSeqRWDevIO = new MCtestDevIOSeqNoIncremental<ACS::booleanSeq>(m_booleanSeqRWVal, m_time33);
	...
	m_EnumTestRWVal = 0;
	m_time34 = 134608945243381570;
	m_EnumTestRWDevIO = new MCtestDevIONoIncremental<EnumTest>(m_EnumTestRWVal, m_time34);
	m_EnumTestRWProp_p = new RWEnumImpl<ACS_ENUM_T(EnumTest), POA_TMCDB_Test::RWEnumTest>(name+":EnumTestRWProp", getComponent(), m_EnumTestRWDevIO);
...
MCtestPropertiesComponentImpl::~MCtestPropertiesComponentImpl()
{
	...
	if(m_longLongSeqROProp_p != 0)
	{
		m_longLongSeqROProp_p->destroy();
		m_longLongSeqROProp_p=0;
	}
	delete m_longLongSeqRODevIO;
	if(m_uLongLongSeqROProp_p != 0)
	{
		m_uLongLongSeqROProp_p->destroy();
		m_uLongLongSeqROProp_p=0;
	}
	delete m_uLongLongSeqRODevIO;
	...
	if(m_longLongSeqRWProp_p != 0)
	{
		m_longLongSeqRWProp_p->destroy();
		m_longLongSeqRWProp_p=0;
	}
	delete m_longLongSeqRWDevIO;
	if(m_uLongLongSeqRWProp_p != 0)
	{
		m_uLongLongSeqRWProp_p->destroy();
		m_uLongLongSeqRWProp_p=0;
	}
	delete m_uLongLongSeqRWDevIO;
...
ACS::ROlongLongSeq_ptr MCtestPropertiesComponentImpl::longLongSeqROProp()
{
	if(m_longLongSeqROProp_p == 0)
	{
		return ACS::ROlongLongSeq::_nil();
	}

	ACS::ROlongLongSeq_var prop = ACS::ROlongLongSeq::_narrow(m_longLongSeqROProp_p->getCORBAReference());
	return prop._retn();
}
ACS::ROuLongLongSeq_ptr MCtestPropertiesComponentImpl::uLongLongSeqROProp()
{
	if(m_uLongLongSeqROProp_p == 0)
	{
		return ACS::ROuLongLongSeq::_nil();
	}

	ACS::ROuLongLongSeq_var prop = ACS::ROuLongLongSeq::_narrow(m_uLongLongSeqROProp_p->getCORBAReference());
	return prop._retn();
}
...
ACS::RWlongLongSeq_ptr MCtestPropertiesComponentImpl::longLongSeqRWProp()
{
	if(m_longLongSeqRWProp_p == 0)
	{
		return ACS::RWlongLongSeq::_nil();
	}

	ACS::RWlongLongSeq_var prop = ACS::RWlongLongSeq::_narrow(m_longLongSeqRWProp_p->getCORBAReference());
	return prop._retn();
}
ACS::RWuLongLongSeq_ptr MCtestPropertiesComponentImpl::uLongLongSeqRWProp()
{
	if(m_uLongLongSeqRWProp_p == 0)
	{
		return ACS::RWuLongLongSeq::_nil();
	}

	ACS::RWuLongLongSeq_var prop = ACS::RWuLongLongSeq::_narrow(m_uLongLongSeqRWProp_p->getCORBAReference());
	return prop._retn();
}
