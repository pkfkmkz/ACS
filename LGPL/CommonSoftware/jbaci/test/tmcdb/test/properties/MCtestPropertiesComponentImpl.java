...
import alma.ACS.ROuLongLongSeq;
import alma.ACS.ROuLongLongSeqHelper;
import alma.ACS.ROuLongLongSeqPOATie;
...
import alma.ACS.RWlongLongSeq;
import alma.ACS.RWlongLongSeqHelper;
import alma.ACS.RWlongLongSeqPOATie;
...
import alma.ACS.RWuLongLongSeq;
import alma.ACS.RWuLongLongSeqHelper;
import alma.ACS.RWuLongLongSeqPOATie;
...
import alma.ACS.impl.ROuLongLongSeqImpl;
...
import alma.ACS.impl.RWlongLongSeqImpl;
...
import alma.ACS.impl.RWuLongLongSeqImpl;
import alma.ACS.jbaci.DataAccess;
import alma.TMCDB_Test.EnumTest;
import alma.TMCDB_Test.MCtestPropertiesComponentOperations;
import alma.TMCDB_Test.ROEnumTest;
import alma.TMCDB_Test.ROEnumTestHelper;
import alma.TMCDB_Test.ROEnumTestOperations;
import alma.TMCDB_Test.ROEnumTestPOATie;
import alma.TMCDB_Test.RWEnumTest;
import alma.TMCDB_Test.RWEnumTestHelper;
import alma.TMCDB_Test.RWEnumTestOperations;
import alma.TMCDB_Test.RWEnumTestPOATie;
...
public class MCtestPropertiesComponentImpl extends CharacteristicComponentImpl
	...
	private String m_stringROVal = "stringRO";
	...
	private ROlongLongSeq m_longLongSeqROProp_p;
	private long[] m_longLongSeqROVal = new long[] {16, 17};
	private long m_time14 = 134608945243381570L;
	private DataAccess<long[]> m_longLongSeqRODevIO = new MCtestDevIONoIncremental<long[]>(m_time14, m_longLongSeqROVal);
	
	private ROuLongLongSeq m_uLongLongSeqROProp_p;
	private long[] m_uLongLongSeqROVal = new long[] {18, 19};
	private long m_time15 = 134608945243381570L;
	private DataAccess<long[]> m_uLongLongSeqRODevIO = new MCtestDevIONoIncremental<long[]>(m_time15, m_uLongLongSeqROVal);
	...
	private DataAccess<boolean[]> m_booleanSeqRODevIO = new MCtestDevIONoIncremental<boolean[]>(m_time16, m_booleanSeqROVal);
	...
	private DataAccess<EnumTest> m_EnumTestRODevIO = new MCtestDevIONoIncremental<EnumTest>(m_time17, m_EnumTestROVal);
	
	//RW
	private RWdouble m_doubleRWProp_p;
	private double m_doubleRWVal = 20D;
	private long m_time18 = 134608945243381570L;
	private DataAccess<Double> m_doubleRWDevIO =  new MCtestDevIONoIncremental<Double>(m_time18, m_doubleRWVal);
	
	private RWfloat m_floatRWProp_p;
	private float m_floatRWVal = 21F;
	private long m_time19 = 134608945243381570L;
	private DataAccess<Float> m_floatRWDevIO = new MCtestDevIONoIncremental<Float>(m_time19, m_floatRWVal);
	
	private RWlong m_longRWProp_p;
	private int m_longRWVal = 22;
	private long m_time20 = 134608945243381570L;
	private DataAccess<Integer> m_longRWDevIO = new MCtestDevIONoIncremental<Integer>(m_time20, m_longRWVal);
	
	private RWuLong m_uLongRWProp_p;
	private int m_uLongRWVal = 23;
	private long m_time21 = 134608945243381570L;
	private DataAccess<Integer> m_uLongRWDevIO = new MCtestDevIONoIncremental<Integer>(m_time21, m_uLongRWVal);
	
	private RWpattern m_patternRWProp_p;
	private long m_patternRWVal = 24;
	private long m_time22 = 134608945243381570L;
	private DataAccess<Long> m_patternRWDevIO = new MCtestDevIONoIncremental<Long>(m_time22, m_patternRWVal);
	
	private RWstring m_stringRWProp_p;
	private String m_stringRWVal = "stringRW";
	private long m_time23 = 134608945243381570L;
	private DataAccess<String> m_stringRWDevIO = new MCtestDevIONoIncremental<String>(m_time23, m_stringRWVal);
	
	private RWlongLong m_longLongRWProp_p;
	private long m_longLongRWVal = 25;
	private long m_time24 = 134608945243381570L;
	private DataAccess<Long> m_longLongRWDevIO = new MCtestDevIONoIncremental<Long>(m_time24, m_longLongRWVal);
	
	private RWuLongLong m_uLongLongRWProp_p;
	private long m_uLongLongRWVal = 26;
	private long m_time25 = 134608945243381570L;
	private DataAccess<Long> m_uLongLongRWDevIO = new MCtestDevIONoIncremental<Long>(m_time25, m_uLongLongRWVal);
	
	private RWboolean m_booleanRWProp_p;
	private boolean m_booleanRWVal = true;
	private long m_time26 = 134608945243381570L;
	private DataAccess<Boolean> m_booleanRWDevIO = new MCtestDevIONoIncremental<Boolean>(m_time26, m_booleanRWVal);
	
	private RWdoubleSeq m_doubleSeqRWProp_p;
	private double[] m_doubleSeqRWVal = new double[]{27D, 28D};
	private long m_time27 = 134608945243381570L;
	private DataAccess<double[]> m_doubleSeqRWDevIO = new MCtestDevIONoIncremental<double[]>(m_time27, m_doubleSeqRWVal);
	
	private RWfloatSeq m_floatSeqRWProp_p;
	private float[] m_floatSeqRWVal = new float[] {29F, 30F};
	private long m_time28 = 134608945243381570L;
	private DataAccess<float[]> m_floatSeqRWDevIO = new MCtestDevIONoIncremental<float[]>(m_time28, m_floatSeqRWVal);
	
	private RWlongSeq m_longSeqRWProp_p;
	private int[] m_longSeqRWVal = new int[]{31, 32};
	private long m_time29 = 134608945243381570L;
	private DataAccess<int[]> m_longSeqRWDevIO = new MCtestDevIONoIncremental<int[]>(m_time29, m_longSeqRWVal);
	
	private RWuLongSeq m_uLongSeqRWProp_p;
	private int[] m_uLongSeqRWVal = new int[]{33, 34};
	private long m_time30 = 134608945243381570L;
	private DataAccess<int[]> m_uLongSeqRWDevIO = new MCtestDevIONoIncremental<int[]>(m_time30, m_uLongSeqRWVal);

	private RWlongLongSeq m_longLongSeqRWProp_p;
	private long[] m_longLongSeqRWVal = new long[]{35, 36};
	private long m_time31 = 134608945243381570L;
	private DataAccess<long[]> m_longLongSeqRWDevIO = new MCtestDevIONoIncremental<long[]>(m_time31, m_longLongSeqRWVal);
	
	private RWuLongLongSeq m_uLongLongSeqRWProp_p;
	private long[] m_uLongLongSeqRWVal = new long[]{37, 38};
	private long m_time32 = 134608945243381570L;
	private DataAccess<long[]> m_uLongLongSeqRWDevIO = new MCtestDevIONoIncremental<long[]>(m_time32, m_uLongLongSeqRWVal);
	
	private RWbooleanSeq m_booleanSeqRWProp_p;
	private boolean[] m_booleanSeqRWVal = new boolean[] {true, false};
	private long m_time33 = 134608945243381570L;
	private DataAccess<boolean[]> m_booleanSeqRWDevIO = new MCtestDevIONoIncremental<boolean[]>(m_time33, m_booleanSeqRWVal);
	
	private RWEnumTest m_EnumTestRWProp_p;
	private EnumTest m_EnumTestRWVal = EnumTest.STATE1;
	private long m_time34 = 134608945243381570L;
	private DataAccess<EnumTest> m_EnumTestRWDevIO = new MCtestDevIONoIncremental<EnumTest>(m_time34, m_EnumTestRWVal);
	...
	public void initialize(ContainerServices containerServices) throws ComponentLifecycleException {
		...
		{
			ROlongLongSeqImpl impl = new ROlongLongSeqImpl("longLongSeqROProp", this, m_longLongSeqRODevIO);
			ROlongLongSeqPOATie tie = new ROlongLongSeqPOATie(impl);
			m_longLongSeqROProp_p = ROlongLongSeqHelper.narrow(registerProperty(impl, tie));
		}
		{
			ROuLongLongSeqImpl impl = new ROuLongLongSeqImpl("uLongLongSeqROProp", this, m_uLongLongSeqRODevIO);
			ROuLongLongSeqPOATie tie = new ROuLongLongSeqPOATie(impl);
			m_uLongLongSeqROProp_p = ROuLongLongSeqHelper.narrow(registerProperty(impl, tie));
		}
		{
		...
		{
			RWlongLongSeqImpl impl = new RWlongLongSeqImpl("longLongSeqRWProp", this, m_longLongSeqRWDevIO);
			RWlongLongSeqPOATie tie = new RWlongLongSeqPOATie(impl);
			m_longLongSeqRWProp_p = RWlongLongSeqHelper.narrow(registerProperty(impl, tie));
		}
		{
			RWuLongLongSeqImpl impl = new RWuLongLongSeqImpl("uLongLongSeqRWProp", this, m_uLongLongSeqRWDevIO);
			RWuLongLongSeqPOATie tie = new RWuLongLongSeqPOATie(impl);
			m_uLongLongSeqRWProp_p = RWuLongLongSeqHelper.narrow(registerProperty(impl, tie));
		}
		{
	...
	@Override
	public ROlongLongSeq longLongSeqROProp() {
		return m_longLongSeqROProp_p;
	}

	@Override
	public ROuLongLongSeq uLongLongSeqROProp() {
		return m_uLongLongSeqROProp_p;
	}
	...
	@Override
	public RWlongLongSeq longLongSeqRWProp() {
		return m_longLongSeqRWProp_p;
	}

	@Override
	public RWuLongLongSeq uLongLongSeqRWProp() {
		return m_uLongLongSeqRWProp_p;
	}
