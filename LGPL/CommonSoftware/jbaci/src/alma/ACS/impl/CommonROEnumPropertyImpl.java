...
public class CommonROEnumPropertyImpl extends ROCommonPropertyImpl {
	...
	public Condition[] condition() {
		try
		{
			int[] temp = characteristicModelImpl.getLongSeq("condition");
	...
	public Object readPropertyTypeCharacteristic(String name)
		...
		return from_int(characteristicModelImpl.getLong(name));
	}
	...
	private Object getEnumArrayFromCharacteristicModel(String name) {
		try
		{
			int[] temp = characteristicModelImpl.getLongSeq(name);
	...
	public Object default_value() {
		try {
			return from_int(characteristicModelImpl.getLong("default_value"));
		} catch (NoSuchCharacteristic e) {
			return from_int(0);
		}
	}
