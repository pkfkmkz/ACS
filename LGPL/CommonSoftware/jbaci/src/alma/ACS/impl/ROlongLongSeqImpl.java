...
/**
 * Implementation of <code>alma.ACS.ROlongLongSeq</code>.
 ...
 * @version $id$
 */
public class ROlongLongSeqImpl
	extends ROCommonComparablePropertyImpl
	implements ROlongLongSeqOperations {
	...
	public Object readPropertyTypeCharacteristic(String name)
		...
		return (characteristicModelImpl.getLongLongSeq(name));
	}

	/**
	 * @see alma.ACS.ROlongLongSeqOperations#alarm_high_off()
	 */
	...
	/**
	 * @see alma.ACS.ROlongLongSeqOperations#alarm_high_on()
	 */
	...
	/**
	 * @see alma.ACS.ROlongLongSeqOperations#alarm_low_off()
	 */
	...
	/**
	 * @see alma.ACS.ROlongLongSeqOperations#alarm_low_on()
	 */
	...
	/**
	 * @see alma.ACS.ROlongLongSeqOperations#new_subscription_Alarm(alma.ACS.AlarmlongLongSeq, alma.ACS.CBDescIn)
	 */
	...
	/**
	 * @see alma.ACS.PlongLongSeqOperations#create_monitor(alma.ACS.CBlongLongSeq, alma.ACS.CBDescIn)
	 */
	public MonitorlongLong create_monitor(CBlongLongSeq callback, CBDescIn descIn) {
		return create_postponed_monitor(0, callback, descIn);
	}

	/**
	 * @see alma.ACS.PlongLongSeqOperations#create_postponed_monitor(longLongSeq, alma.ACS.CBlongLongSeq, alma.ACS.CBDescIn)
	 */
	public MonitorlongLong create_postponed_monitor(
		long startTime,
		CBlongLongSeq callback,
		CBDescIn descIn) {
	...
	/**
	 * @see alma.ACS.PlongLongSeqOperations#default_value()
	 */
	...
	/**
	 * @see alma.ACS.PlongLongSeqOperations#get_async(alma.ACS.CBlongLongSeq, alma.ACS.CBDescIn)
	 */
	public void get_async(CBlongLongSeq arg0, CBDescIn arg1) {
		getAsync(arg0, arg1);
	}

	/**
	 * @see alma.ACS.PlongLongSeqOperations#get_history(int, alma.ACS.longLongSeqSeqHolder, alma.ACS.TimeSeqHolder)
	 */
	public int get_history(
		int arg0,
		longLongSeqSeqHolder arg1,
		TimeSeqHolder arg2) {
	...
	/**
	 * @see alma.ACS.PlongLongSeqOperations#get_sync(alma.ACSErr.CompletionHolder)
	 */
	...
	/**
	 * @see alma.ACS.PlongLongSeqOperations#graph_max()
	 */
	...
	/**
	 * @see alma.ACS.PlongLongSeqOperations#graph_min()
	 */
	...
	/**
	 * @see alma.ACS.PlongLongSeqOperations#min_delta_trigger()
	 */
	...
	/**
	 * @see alma.ACS.PlongLongSeqOperations#min_step()
	 */
	...
	public boolean dispatchCallback(
		...
		{	
			if (type == CallbackDispatcher.CallbackType.DONE_TYPE)
				((CBlongLongSeq)callback).done(((long[])value), completion, desc);
			else if (type == CallbackDispatcher.CallbackType.WORKING_TYPE)
				((CBlongLongSeq)callback).working(((long[])value), completion, desc);
			else 
				return false;
	...
	/**
	 * @see alma.ACS.ROlongLongSeqOperations#enable_alarm_system()
	 */
	...
	/**
	 * @see alma.ACS.ROlongLongSeqOperations#disable_alarm_system() throws alma.baciErrTypeProperty.DisableAlarmsErrorEx
	 */
	...
	/**
	 * @see alma.ACS.ROlongLongSeqOperations#alarm_system_enabled()
	 */
