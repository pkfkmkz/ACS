...
public class ROlongLongImpl
	...
	public Object sum(Object value1, Object value2, boolean substract) {
		...
		if (substract)
			val2 = -val2;
		return Long.valueOf((long) (((Long)value1).longValue() + val2));
	}
	...
	public Object readPropertyTypeCharacteristic(String name)
		...
		return Long.valueOf(characteristicModelImpl.getLongLong(name));
	}
	...
	/**
	 * @see alma.ACS.ROlongLongOperations#enable_alarm_system()
	 */
	...
	/**
	 * @see alma.ACS.ROlongLongOperations#disable_alarm_system() throws alma.baciErrTypeProperty.DisableAlarmsErrorEx
	 */
	...
	/**
	 * @see alma.ACS.ROlongLongOperations#alarm_system_enabled()
	 */
