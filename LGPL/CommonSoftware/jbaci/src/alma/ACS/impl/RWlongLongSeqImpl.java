...
import alma.ACS.RWlongLongSeqOperations;
...
/**
 * Implementation of <code>alma.ACS.RWlongLongSeq</code>.
 ...
 * @version $id$
 */
public class RWlongLongSeqImpl
	extends RWCommonComparablePropertyImpl
	implements RWlongLongSeqOperations {
	...
	public void get_async(CBlongLongSeq cb, CBDescIn desc) {
	...
	/**
	 * @see alma.ACS.PlongOperations#get_history(int, alma.ACS.longLongSeqHolder, alma.ACS.TimeSeqHolder)
	 */
