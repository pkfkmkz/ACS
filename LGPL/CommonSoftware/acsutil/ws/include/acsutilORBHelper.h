...
class ORBHelper
{
  public:
    ...
    /**
     * checkObject(CORBA::Object_ptr obj)
     * Checks the status of an object, trying to refresh stale connectiuons
     * @return true if the connection is working after refresh or false otherwise
     */
    static bool checkObject(CORBA::Object_ptr obj);
