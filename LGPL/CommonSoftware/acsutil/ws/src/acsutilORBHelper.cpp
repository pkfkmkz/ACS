    ...
    orbRunYet_m(false)
{
    ...
    //initialize the ORB
    orb_mp = CORBA::ORB_init(argc, const_cast<char**>(argv), "");
...
bool ORBHelper::checkObject(CORBA::Object_ptr obj) {
    bool ok = true;
    CORBA::PolicyList_var policies;
    try {
        obj->_validate_connection(policies.out());
    } catch (...) {
        try {
            obj->_validate_connection(policies.out());
        } catch (...) {
