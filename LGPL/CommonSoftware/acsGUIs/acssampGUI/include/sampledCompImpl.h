...
class sampledCompImpl: public virtual baci::CharacteristicComponentImpl,
		     public virtual POA_SAMP::SampledComponent
{
	...
	private:
		baci::SmartPropertyPointer<baci::RWdouble>   m_RWdouble_sp;
		baci::SmartPropertyPointer<baci::ROdouble>   m_ROdouble_sp;
		baci::SmartPropertyPointer<baci::RWfloat>    m_RWfloat_sp;
		baci::SmartPropertyPointer<baci::ROfloat>    m_ROfloat_sp;
		baci::SmartPropertyPointer<baci::RWstring>   m_RWstring_sp;
		baci::SmartPropertyPointer<baci::ROstring>   m_ROstring_sp;
		baci::SmartPropertyPointer<baci::RWlong>     m_RWlong_sp;
		baci::SmartPropertyPointer<baci::ROlong>     m_ROlong_sp;
		baci::SmartPropertyPointer<baci::RWlongLong> m_RWlongLong_sp;
		baci::SmartPropertyPointer<baci::ROlongLong> m_ROlongLong_sp;
