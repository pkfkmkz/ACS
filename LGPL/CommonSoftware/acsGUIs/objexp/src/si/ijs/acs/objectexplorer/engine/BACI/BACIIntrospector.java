 ...
 */
	public java.lang.Object extractAny(TypeCode tc, Any argument) {
		...
		switch(tc.kind().value())
		{
			...
			case TCKind._tk_double:
				return Double.valueOf(argument.extract_double());
			case TCKind._tk_float:
				return Float.valueOf(argument.extract_float());
			case TCKind._tk_octet:
				//return Byte.valueOf(argument.extract_octet());
				// use short to get unsigned value 
				return Short.valueOf((short)(argument.extract_octet() & 0xFF));
			case TCKind._tk_longlong:
				return Long.valueOf(argument.extract_longlong());
			case TCKind._tk_ulonglong:
				return Long.valueOf(argument.extract_ulonglong());
			case TCKind._tk_long:
				return Integer.valueOf(argument.extract_long());
			case TCKind._tk_ulong:
				return Integer.valueOf(argument.extract_ulong());
			case TCKind._tk_short:
				return Short.valueOf(argument.extract_short());
			case TCKind._tk_ushort:
				return Short.valueOf(argument.extract_ushort());
			case TCKind._tk_string:
				return argument.extract_string();
			case TCKind._tk_char:
				return Character.valueOf(argument.extract_char());
			case TCKind._tk_boolean:
				return Boolean.valueOf(argument.extract_boolean());
			default:
	...
	public void displayAny(TypeCode tc, Any argument) {
		...
		switch(tc.kind().value())
		{
			...
			case TCKind._tk_array:
				...
				break;
			case TCKind._tk_double:
				System.out.println(Double.valueOf(argument.extract_double()));
				break;
			case TCKind._tk_float:
				System.out.println(Float.valueOf(argument.extract_float()));
				break;
			case TCKind._tk_octet:
				//return Byte.valueOf(argument.extract_octet());
				// use short to get unsigned value 
				System.out.println(Short.valueOf((short)(argument.extract_octet() & 0xFF)));
				break;
			case TCKind._tk_longlong:
				System.out.println(Long.valueOf(argument.extract_longlong()));
				break;
			case TCKind._tk_ulonglong:
				System.out.println(Long.valueOf(argument.extract_ulonglong()));
				break;
			case TCKind._tk_long:
				System.out.println(Integer.valueOf(argument.extract_long()));
				break;
			case TCKind._tk_ulong:
				System.out.println(Integer.valueOf(argument.extract_ulong()));
				break;
			case TCKind._tk_short:
				System.out.println(Short.valueOf(argument.extract_short()));
				break;
			case TCKind._tk_ushort:
				System.out.println(Short.valueOf(argument.extract_ushort()));
				break;
			case TCKind._tk_string:
				System.out.println(argument.extract_string());
				break;
			case TCKind._tk_char:
				System.out.println(Character.valueOf(argument.extract_char()));
				break;
			case TCKind._tk_boolean:
				System.out.println(Boolean.valueOf(argument.extract_boolean()));
				break;
			default:
				throw new IllegalArgumentException("Argument typecode '" + argument.type().kind().value() + "' is not supported.");
		}
