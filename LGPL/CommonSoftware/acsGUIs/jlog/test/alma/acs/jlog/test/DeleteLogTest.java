...
public class DeleteLogTest extends TestCase {
	...
	public void testGetFirstLogLogFileCache() throws Exception{
		...
		for (int t=0; t<2048; t++) {
			cache.deleteLog(t);
			assertEquals("Error getting the first log",cache.getFirstLog(),Integer.valueOf(t+1));
		}
	}
	...
	public void testGetLastLogLogFileCache() throws Exception{
		...
		for (int t=4095; t<2048; t--) {
			cache.deleteLog(t);
			assertEquals("Error getting the last log",cache.getLastLog(),Integer.valueOf(t-1));
		}
	}
	...
	public void testGetLastLogLogBufferedFileCache() throws Exception{
		...
		for (int t=4095; t<1000; t++) {
			cache.deleteLog(t);
			assertEquals("Error getting the first log",cache.getLastLog(),Integer.valueOf(t-1));
		}
	}
	...
	public void testDeleteLogsFromLogFileCache() throws Exception {
		...
		keysInCache.remove(Integer.valueOf(0));
		keysInCache.remove(Integer.valueOf(4095));
