...
s/<type '\([a-zA-Z]*\)'>/<class '\1'>/
s/OctetSeq:1.0 ': <class 'int'>/OctetSeq:1.0 ': <class 'xxx'>/
s/OctetSeq:1.0 ': <class 'str'>/OctetSeq:1.0 ': <class 'xxx'>/
s/<class 'long'>/<class 'int'>/
s/instance at/object at/
s/Servants.Representations.Dynamic.Dynamic(/Servants.Representations.Dynamic.Dynamic'>(/
s/Servants.Representations.CDB.CDB(/Servants.Representations.CDB.CDB'>(/
