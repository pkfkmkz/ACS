...
if __name__ == "__main__":
    ...
    print("PowerSupply dict:", [p for p in dir(h) if not p.startswith("__")])

    print("-----------------------------------------------------------------")
    i = DynamicImplementation("IDL:alma/RampedPS/RampedPowerSupply:1.0")
    print("PowerSupply dict:", [p for p in dir(i) if not p.startswith("__")])
    print("-----------------------------------------------------------------")
    try:
        j =  DynamicImplementation("IDL:alma/doesnt/Exist:1.0")
    except ImportError as ex:
        print("Good...ImportError when trying to create 'IDL:alma/doesnt/Exist:1.0'")
