...
public class Log4jAdapterTest extends JUnit4StandaloneTestBase
{
	...
	public void testLog4jLogger() throws Exception {
		...
		Log4jContextSelector.enableAcsLogging();
		...
		org.apache.logging.log4j.Logger log4jLogger = org.apache.logging.log4j.LogManager.getLogger(getClass());
		log4jLogger.info("log4jLogger speaking INFO ...");
		
		// Some other logger, should again be "unknown@<TestMethodName>".
		org.apache.logging.log4j.Logger log4jLogger2 = org.apache.logging.log4j.LogManager.getLogger("someOtherLog4jLogger");
