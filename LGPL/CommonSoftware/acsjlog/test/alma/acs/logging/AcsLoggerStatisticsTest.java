...
public class AcsLoggerStatisticsTest extends TestCase {
	...
	protected void setUp() throws Exception {
		System.out.println("\n------------ " + getName() + " --------------");
		LocalOnlyAcsLogger.resetInstance();
	...
	public void testLoggerStatisticsParameters() {
		...
		if(System.getenv("LOCATION") != null) {
			assertEquals(false, acsLogger.stats.getDisableStatistics().booleanValue());
			assertEquals(10 * 60, acsLogger.stats.getStatisticsCalculationPeriod());
			assertEquals(3, acsLogger.stats.getStatisticsGranularity());
		} else {
			assertEquals(true, acsLogger.stats.getDisableStatistics().booleanValue());
		}
	}
	
	public void testLoggerStatisticsParametersConfiguration() {
