...
s/Thread=omniORB-\+\([0-9]\)\+/Thread=NNNN-XXXXXXX/g 
s/Thread=Dummy-\+\([0-9]\)\+/Thread=NNNN-XXXXXXX/g 
...
s/1 - Manager hostname generated using localhost address: '[0-9]*\.[0-9]*\.[0-9]*\.[0-9]*'/1 - Manager hostname generated using localhost address: 'xxx.xxx.xxx.xxx'/g
...
s/- [^ ]\+: \(CORBA\.[A-Z_]\+\)(\(0x[0-9]\+\), \(CORBA\.COMPLETED_[A-Z]\+\))/- omniORB.CORBA._omni_sys_exc: \1(\2, \3)/
