...
#include <SimpleExampleTypeSupportImpl.h>
...
int main(int argc, char**argv)
{
	...
	ACS_NEW_DDS_SUBSCRIBER(sub_p, DDS_SIMPLE_EXAMPLE::simpleMessage, DDS_SIMPLE_EXAMPLE::DOMAIN_ID,
			DDS_SIMPLE_EXAMPLE::CHANNEL_NAME,"profileTest", &handlerFunction, (void *)0);
