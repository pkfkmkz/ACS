	...
	m_EnumTestRWProp_p(0)
{
	...
	m_longLongSeqROVal.length(2);
	for(unsigned int i=0;i<m_longLongSeqROVal.length();i++)
		m_longLongSeqROVal[i]=0;
	...
	m_uLongLongSeqROVal.length(2);
	for(unsigned int i=0;i<m_uLongLongSeqROVal.length();i++)
		m_uLongLongSeqROVal[i]=0;
