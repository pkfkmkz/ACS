...
namespace TMCDB
{
	...
	class MCtestPropertiesComponentImpl :
		...
		public POA_TMCDB_Test::MCtestPropertiesComponent
	{
	  public:
		...
		ACS::ROlongLongSeq_ptr longLongSeqROProp();
		ACS::ROuLongLongSeq_ptr uLongLongSeqROProp();
		ACS::RObooleanSeq_ptr booleanSeqROProp();
		TMCDB_Test::ROEnumTest_ptr EnumTestROProp();
		...
		ACS::RWlongLongSeq_ptr longLongSeqRWProp();
		ACS::RWuLongLongSeq_ptr uLongLongSeqRWProp();
		ACS::RWbooleanSeq_ptr booleanSeqRWProp();
		TMCDB_Test::RWEnumTest_ptr EnumTestRWProp();
	  ...
	  private:
		...
		baci::ROlongLongSeq *m_longLongSeqROProp_p;
		ACS::longLongSeq m_longLongSeqROVal;
		ACS::Time m_time14;
		DevIO<ACS::longLongSeq> *m_longLongSeqRODevIO;
		baci::ROuLongLongSeq *m_uLongLongSeqROProp_p;
		ACS::uLongLongSeq m_uLongLongSeqROVal;
		ACS::Time m_time15;
		DevIO<ACS::uLongLongSeq> *m_uLongLongSeqRODevIO;
		baci::RObooleanSeq *m_booleanSeqROProp_p;
		ACS::booleanSeq m_booleanSeqROVal;
		ACS::Time m_time16;
		DevIO<ACS::booleanSeq> *m_booleanSeqRODevIO;
		ROEnumImpl<ACS_ENUM_T(TMCDB_Test::EnumTest), POA_TMCDB_Test::ROEnumTest> *m_EnumTestROProp_p;
		TMCDB_Test::EnumTest m_EnumTestROVal;
		ACS::Time m_time17;
		DevIO<TMCDB_Test::EnumTest> *m_EnumTestRODevIO;
		//RW
		...
		baci::RWlongLongSeq *m_longLongSeqRWProp_p;
		ACS::longLongSeq m_longLongSeqRWVal;
		ACS::Time m_time31;
		DevIO<ACS::longLongSeq> *m_longLongSeqRWDevIO;
		baci::RWuLongLongSeq *m_uLongLongSeqRWProp_p;
		ACS::uLongLongSeq m_uLongLongSeqRWVal;
		ACS::Time m_time32;
		DevIO<ACS::uLongLongSeq> *m_uLongLongSeqRWDevIO;
		baci::RWbooleanSeq *m_booleanSeqRWProp_p;
		ACS::booleanSeq m_booleanSeqRWVal;
		ACS::Time m_time33;
		DevIO<ACS::booleanSeq> *m_booleanSeqRWDevIO;
		RWEnumImpl<ACS_ENUM_T(TMCDB_Test::EnumTest), POA_TMCDB_Test::RWEnumTest> *m_EnumTestRWProp_p;
		TMCDB_Test::EnumTest m_EnumTestRWVal;
		ACS::Time m_time34;
		DevIO<TMCDB_Test::EnumTest> *m_EnumTestRWDevIO;
		/**
