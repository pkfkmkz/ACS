...
public:
  ...
  void setReceiverFlow(BulkDataNTReceiverFlow* _receiverFlow_p) {receiverFlow_m = _receiverFlow_p;}
  BulkDataNTReceiverFlow* getReceiverFlow(){return receiverFlow_m;}
...
protected:
  ...
  AcsBulkdata::BulkDataNTReceiverFlow* receiverFlow_m;
	/*
