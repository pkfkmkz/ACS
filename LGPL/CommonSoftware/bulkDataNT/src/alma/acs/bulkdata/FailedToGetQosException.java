...
/**
 * This exception indicates that BulkData API fails to get QoS from
 * the underlying DDS library.
 *
 * @author Takashi Nakamoto
 */
@SuppressWarnings("serial")
public class FailedToGetQosException extends DdsException {
    /**
     ...
     */
    public FailedToGetQosException(String msg,
                                   RETCODE_ERROR cause,
