...
public:
	...
	{
		std::string userParam(reinterpret_cast<char*>(userParam_p), size);
		ACS_SHORT_LOG((LM_INFO, "=>cbStart[%s/%s]: got %d: %s", recvName_m.c_str(), flowName_m.c_str(), size, userParam.c_str()));
