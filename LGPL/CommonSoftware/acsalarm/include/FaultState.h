	...
	{	
		public:
			...
			*/
			 ...
			 */
			virtual void setUserProperties(std::shared_ptr<acsalarm::Properties> theProperties) { userProperties = theProperties; }
			 ...
			 */
			virtual void setUserTimestamp(std::shared_ptr<acsalarm::Timestamp> theTimestamp) { userTimestamp = theTimestamp; }
		...
		private:
			...
			std::shared_ptr<acsalarm::Properties> userProperties;
			std::shared_ptr<acsalarm::Timestamp> userTimestamp;
	};
}
#endif /*FAULTSTATE_H_*/
