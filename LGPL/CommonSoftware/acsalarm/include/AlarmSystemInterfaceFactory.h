...
class AlarmSystemInterfaceFactory 
{
	 ...
	 */
	virtual std::shared_ptr<acsalarm::FaultState>createFaultState(std::string family, std::string member, int code);
	
	/**
	 * Create a fault state 
	 */
	virtual std::shared_ptr<acsalarm::FaultState>createFaultState();
};
