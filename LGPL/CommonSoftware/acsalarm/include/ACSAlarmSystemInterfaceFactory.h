...
// We would need to make static methods non-static to do so...
{
	 ...
	 */
	static AlarmSystemType usingACSAlarmSystem();
	 ...
	 */
	static acsalarm::AlarmSystemInterface* createSource(std::string sourceName);
	 ...
	 * @return the interface instance.
	 */
	static acsalarm::AlarmSystemInterface* createSource();
	 ...
	 * @throw ACSASFactoryNotInitedExImpl if the alarm system has not been previously initialized.
	 */
	static std::shared_ptr<acsalarm::FaultState>createFaultState(std::string family, std::string member, int code);
	
	/**
	 * Create a fault state 
	 * @throw ACSASFactoryNotInitedExImpl if the alarm system has not been previously initialized.
	 */
	static std::shared_ptr<acsalarm::FaultState>createFaultState();
