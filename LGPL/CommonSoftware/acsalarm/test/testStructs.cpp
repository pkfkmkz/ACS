...
void AcsAlarmTestCase::testProps()
{
	...
	properties.setProperty(key2, value2);
	std::shared_ptr< std::vector<std::string> > keys = properties.propertyNames();
	...
	std::shared_ptr< std::vector<std::string> > keys2 = properties2.propertyNames();
	...
	std::shared_ptr< std::vector<std::string> > keys3 = properties3.propertyNames();
