...
void AcsAlarmTestCase::testProps()
{
	...
	properties.setProperty(key2, value2);
	shared_ptr< vector<string> > keys = properties.propertyNames();
	...
	shared_ptr< vector<string> > keys2 = properties2.propertyNames();
	...
	shared_ptr< vector<string> > keys3 = properties3.propertyNames();
...
void AcsAlarmTestCase::testFaultState()
{
	...
	shared_ptr<acsalarm::FaultState> fltstate = ACSAlarmSystemInterfaceFactory::createFaultState(family, member, CODE_VALUE);
