...
class AcsAlarmTestCase : public CPPUNIT_NS::TestFixture
{
  ...
  protected:
	...
	private:
		...
		void commonTestASIMessage(shared_ptr<vector<FaultState> > fltstates, bool fullyPopulated);
...
void AcsAlarmTestCase::commonTestASIMessage(shared_ptr<vector<FaultState> > statesAutoPtr, bool fullyPopulated)
{
	...
	shared_ptr<Timestamp> timestampAutoPtr(timestampPtr);
...
void AcsAlarmTestCase::testASIMessageFaultStateNotPopulated()
{
	...
	shared_ptr<vector<FaultState> > statesAutoPtr(statesPtr); 
...
void AcsAlarmTestCase::testASIMessageFaultStatePopulated()
{
	...
	shared_ptr<Timestamp> tstampAutoPtr(tstampPtr);
