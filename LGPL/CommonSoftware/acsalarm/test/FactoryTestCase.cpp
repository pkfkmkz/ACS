 ...
 * module.
 */
class FactoryTestCase : public CppUnit::TestFixture
{
...
void FactoryTestCase::testFaultStateCreation()
{
	...
	clearCdbCache();
	ACSAlarmSystemInterfaceFactory::init(myMockMgr);
	shared_ptr<acsalarm::FaultState> fltstate = ACSAlarmSystemInterfaceFactory::createFaultState("Family", "Member", 0);
