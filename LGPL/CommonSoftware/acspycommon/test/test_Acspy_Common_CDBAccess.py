...
class CDBAccessCheck(unittest.TestCase):
    ...
    @mock.patch.object(Acspy.Common.CDBAccess, 'cdb')
    ...
    def testGetTopElement(self):
        ...
        self.assertEqual(['ImplLang','ManagerRetry','Timeout','UseIFR','xmlns','xmlns:baci','xmlns:cdb','xmlns:log','xmlns:xsi'], sorted(list(attribs[0].keys())))
    ...
    def testGetNestedElementAttr(self):
        ...
        self.assertEqual(['centralizedLogger','dispatchPacketSize','immediateDispatchLevel','minLogLevel'], sorted(list(attribs[0].keys())))
