...
if __name__ == "__main__":
    ...
    testCallback(Callbacks.CBlongLongSeq(archive=1))
    testCallback(Callbacks.CBuLong(archive=1))
    testCallback(Callbacks.CBuLongSeq(archive=1))
    testCallback(Callbacks.CBuLongLong(archive=1))
    testCallback(Callbacks.CBuLongLongSeq(archive=1))
    ...
    testCallback(Callbacks.CBlongLongSeq())
    testCallback(Callbacks.CBuLong())
    testCallback(Callbacks.CBuLongSeq())
    testCallback(Callbacks.CBuLongLong())
    testCallback(Callbacks.CBuLongLongSeq())
