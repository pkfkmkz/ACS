...
#
# "@(#) $Id: test_Acspy_Common_ACSHandler.py,v 1.1.1.1 2012/03/07 17:40:45 acaproni Exp $"
#
# who       when      what
# --------  --------  ----------------------------------------------
...
#------------------------------------------------------------------------------
__revision__ = "$Id: test_Acspy_Common_ACSHandler.py,v 1.1.1.1 2012/03/07 17:40:45 acaproni Exp $"
#--REGULAR IMPORTS-------------------------------------------------------------
import unittest
import mock
...
class ACSHandlerCheck(unittest.TestCase):
    ...
    def testSendLog(self):
        ...
        self.assertEqual(expected, [ n[0] for n in mockLogSvc.method_calls[-len(keys)+1:]])
    ...
    def testSendLogErrorTrace(self):
        ...
        self.assertEqual("logErrorWithPriority", logcall[0])
        self.assertEqual(ACSLog.ACS_LOG_ERROR, logcall[1][1])
    ...
    def testSendLogWithAudience(self):
        ...
        h.sendLog(lr)
        logcall = mockLogSvc.method_calls[-1]
        self.assertEqual("logWithAudience", logcall[0])
        self.assertEqual(ACSLog.ACS_LOG_ERROR, logcall[1][0])
    ...
    def testSendLogWithPriority(self):
        ...
        h.sendLog(lr)
        logcall = mockLogSvc.method_calls[-1]
        self.assertEqual("logWithPriority", logcall[0])
        self.assertEqual(ACSLog.ACS_LOG_ERROR, logcall[1][0])
        self.assertEqual(True, isinstance(logcall[1][3], ACSLog.RTContext))
        self.assertEqual(ctxt, logcall[1][3])
        self.assertEqual(True, isinstance(logcall[1][4], ACSLog.SourceInfo))
        self.assertEqual(srcinf, logcall[1][4])
    ...
    def testSendLogWithPriorityBadContextandSource(self):
        ...
        self.assertEqual(ACSLog.ACS_LOG_ERROR, logcall[1][0])
        self.assertEqual(True, isinstance(logcall[1][3], ACSLog.RTContext))
        self.assertEqual(False, logcall[1][3] is None)
        self.assertEqual(True, isinstance(logcall[1][4], ACSLog.SourceInfo))
        self.assertEqual(False, logcall[1][4] is None)
    ...
    def testFlush(self):
        ...
        h.flush()
        self.assertEqual(expected, [ n[0] for n in mockLogSvc.method_calls[-2:]])
    ...
    def testFlushException(self):
        ...
        h.flush()
        self.assertEqual(expected, [ n[0] for n in h.file_handler.method_calls[-2:]])
