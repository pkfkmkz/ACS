...
class LogLevelsCheck(unittest.TestCase):
    ...
    def testLogLevelMapping(self):
        ...
        self.assertEqual(Log.LEVELS[2], Log.logging.TRACE)
    ...
    def testLogLevelReverseMapping(self):
        ...
        self.assertEqual(2, Log.RLEVELS[Log.logging.TRACE])
...
class EnvVariableDefaultCheck(unittest.TestCase):
    ...
    def testDefaultValues(self):
        ...
        self.assertEqual(False, 'ACS_LOG_STDOUT' in environ)
        self.assertEqual(False, 'ACS_LOG_CENTRAL' in environ)
        self.assertEqual(3, Log.ACS_LOG_STDOUT)
        self.assertEqual(3, Log.ACS_LOG_CENTRAL)
...
class StdoutEnvVariableCheck(unittest.TestCase):
    ...
    def testStdoutSetting(self):
        ...
        self.assertEqual(False, 'ACS_LOG_CENTRAL' in environ)
        self.assertEqual(True, 'ACS_LOG_STDOUT' in environ)
        self.assertEqual('2', environ['ACS_LOG_STDOUT'])
        self.assertEqual(2, Log.ACS_LOG_STDOUT)
        self.assertEqual(3, Log.ACS_LOG_CENTRAL)
...
class CentralEnvVariableCheck(unittest.TestCase):
    ...
    def testStdoutSetting(self):
        ...
        self.assertEqual(False, 'ACS_LOG_STDOUT' in environ)
        self.assertEqual(True, 'ACS_LOG_CENTRAL' in environ)
        self.assertEqual('2', environ['ACS_LOG_CENTRAL'])
        self.assertEqual(2, Log.ACS_LOG_CENTRAL)
        self.assertEqual(3, Log.ACS_LOG_STDOUT)
...
#        self.mylogger.setLevels(maci.LoggingConfigurable.LogLevels(False,0, 0))
        keys = list(Acspy.Common.Log.LEVELS.keys())
        keys.sort()
        for l in keys:
            if l == 0 or l == 99:
...
class NoLoggerCheck(unittest.TestCase):
    ...
    def testGetLoggerNames(self):
        ...
        self.assertEqual(True, [] == namelist or ['UnitTestContainer'] == namelist)
...
class PeriodicFlushCheck(unittest.TestCase):
    ...
    def testCycleStartStop(self):
        ...
        self.assertEqual(False, Log.FLUSHTHREAD.is_alive())
