...
class TestGetManagerCorbaLoc(unittest.TestCase):
    ...
    @mock.patch.object(ACSCorba, 'getIP')
    @mock.patch.object(ACSCorba, 'getManagerPort')
...
class TestGetORB(unittest.TestCase):
    ...
    @mock.patch.object(ACSCorba.CORBA, 'ORB_init')
    ...
    @mock.patch.object(ACSCorba.CORBA, 'ORB_init')
    @mock.patch.object(ACSCorba, 'getPOARoot')
...
class TestGetPOARoot(unittest.TestCase):
    ...
    @mock.patch.object(ACSCorba, 'getORB')
...
class TestGetManager(unittest.TestCase):
    ...
    @mock.patch.object(ACSCorba, 'getORB')
    @mock.patch.object(ACSCorba, 'getManagerCorbaloc')
    ...
    @mock.patch.object(ACSCorba, 'getManagerCorbaloc')
    @mock.patch.object(ACSCorba.CORBA, 'is_nil')
    @mock.patch.object(ACSCorba, 'getORB')
...
class TestGetClient(unittest.TestCase):
    ...
    @mock.patch.object(ACSCorba, '_Client')
...
class Test_Client(unittest.TestCase):
    ...
    @mock.patch.object(ACSCorba, 'getManager', mockManager)
    @mock.patch.object(ACSCorba, 'getPOAManager')
    @mock.patch.object(ACSCorba._Client, '_this')
    ...
    @mock.patch.object(ACSCorba, 'getManager')
    @mock.patch.object(ACSCorba, 'getPOAManager')
    @mock.patch.object(ACSCorba._Client, '_this')
