...
class TestErrorTraceHelper(unittest.TestCase):
    ...
    def test_getErrorTrace(self):
        ...
        self.assertEqual(True, isinstance(self.eth.getErrorTrace(),mock.Mock))
    ...
    def test_object_initialization(self):
        ...
        self.assertEqual(True, self.ethd.error_trace is None)

    def test_object_initialization_withtrace(self):
        """ErrorTraceHelper initializes with provided trace"""
        self.assertEqual(True, self.eth.error_trace is not None)
    ...
    def test_setData_emptylist(self):
        ...
        self.assertEqual(['5.5'], self.eth.getData('key'))
...
class TestErrorTrace(unittest.TestCase):
    def test_object_initialization_default(self):
        ...
        et = ET.ErrorTrace(0,0, level=4)
        self.assertEqual('case.py', os.path.split(et.file)[1])
        ...
        self.assertEqual(True, isinstance(et.timeStamp,int) )
    ...
    def test_object_initialization(self):
        ...
        self.assertEqual(277, et.lineNum)
