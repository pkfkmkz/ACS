...
pStr = e1.toString(acstime.TSArray,"", 0, 0)

print(pStr)
pStr = e1.toString(acstime.TSArray,allOut,0, 0)

print(pStr)
utc = e1.toUTCdate(0, 0)

julian = e1.toJulianYear(0, 0)

#mjdSeconds = e1.toMJDseconds()

print(repr(utc), repr(julian))  #, mjdSeconds
...
pStr = e1.toString(acstime.TSArray,"%x",0, 0)
