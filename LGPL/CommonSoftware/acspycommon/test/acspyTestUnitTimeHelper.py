...
class TimeUtilCheck(unittest.TestCase):
    ...
    def testPy2EpochACSEpoch(self):
        ...
        rtn = self.th.py2epoch(old_div(-acstime.ACE_BEGIN, 10000000))
    ...
    def testEpoch2PyEpoch(self):
        ...
        self.assertEqual(True, isinstance(rtn, int))
        self.assertEqual(old_div(-acstime.ACE_BEGIN, 10000000), rtn)
