...
'''
This module provides an implementation of the PlongLongSeq IDL interface:
'''
...
#--P property------------------------------------------------------------------
#------------------------------------------------------------------------------
class PlongLongSeq(GenericProperty):
    '''
    Properties can be derived from PlongLongSeq only if their IDL derives from
    ACS::PlongLongSeq.
    '''
    #--------------------------------------------------------------------------
...
#--RO property-----------------------------------------------------------------
#------------------------------------------------------------------------------
class ROlongLongSeq(ACS__POA.ROlongLongSeq, PlongLongSeq):
    '''
    Properties can be derived from ROlongLongSeq only if their IDL derives from
    ACS::ROlongLongSeq.
    '''
    #--------------------------------------------------------------------------
    def __init__(self, name, charCompRef, devIORef=None):
        ...
        Raises: Nothing.
        '''
        PlongLongSeq.__init__(self, name, charCompRef, devIORef)
        return
    #--------------------------------------------------------------------------
    #--Overriden methods because BACI is inconsistent--------------------------
    #--------------------------------------------------------------------------
...
#--RW property----------------------------------------------------------------
#-----------------------------------------------------------------------------
class RWlongLongSeq(ACS__POA.RWlongLongSeq, ROlongLongSeq):
    '''
    Properties can be derived from ROlongLongSeq only if their IDL derives from
    ACS::ROlongLongSeq.
    '''
    ...
    def __init__(self, name, charCompRef, devIORef=None):
        ...
        Raises: Nothing.
        '''
        ROlongLongSeq.__init__(self, name, charCompRef, devIORef)
        return
    #--------------------------------------------------------------------------
    #--Overriden methods because BACI is inconsistent--------------------------
    #--------------------------------------------------------------------------
