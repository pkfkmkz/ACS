...
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
class MonitorlongLong(ACS__POA.MonitorlongLong, GenericMonitor):
    '''
    Properties can be derived from MonitorlongLong only if their IDL derives from
    ACS::MonitorlongLong.
    '''
    #--------------------------------------------------------------------------
    def __init__(self, scheduler, timeoutID):
...
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
class MonitoruLong(ACS__POA.MonitoruLong, GenericMonitor):
    '''
    Properties can be derived from MonitoruLong only if their IDL derives from
    ACS::MonitoruLong.
    '''
    #--------------------------------------------------------------------------
    def __init__(self, scheduler, timeoutID):
...
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
class MonitoruLongLong(ACS__POA.MonitoruLongLong, GenericMonitor):
    '''
    Properties can be derived from MonitoruLongLong only if their IDL derives from
    ACS::MonitoruLongLong.
    '''
    #--------------------------------------------------------------------------
    def __init__(self, scheduler, timeoutID):
        '''
