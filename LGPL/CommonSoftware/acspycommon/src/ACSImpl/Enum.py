...
class Penum(GenericProperty):
    ...
    def __init__(self, name, charCompRef, devIORef):
        ...
        self.tGlobals = {}
        self.tLocals  = {}
        exec("import " + self.modName, self.tGlobals, self.tLocals)
    ...
    def coerceToPropertyType(self, value=None):
        ...
        if value==None or value=="Max" or value=="Min":
    ...
    def monitorRunner(self, cb, desc):
        ...
        cb.working(int(allList.index(value)), compl, CBDescOut(0, desc.id_tag))     
        return
    #--------------------------------------------------------------------------
    ...
    def get_async(self, cb, desc):
        ...
        cb.done(int(allList.index(retVal)),
                compl,
                CBDescOut(0, desc.id_tag))
        return 
#------------------------------------------------------------------------------
_enumClassDict = {}
...
def getEnumClass(repositoryID):
    ...
    if repositoryID in _enumClassDict:
