...
'''
This module provides an implementation of the PuLongSeq IDL interface:
'''
...
#--P property------------------------------------------------------------------
#------------------------------------------------------------------------------
class PuLongSeq(GenericProperty):
    '''
    Properties can be derived from PuLongSeq only if their IDL derives from
    ACS::PuLongSeq.
    '''
    #--------------------------------------------------------------------------
...
#--RO property-----------------------------------------------------------------
#------------------------------------------------------------------------------
class ROuLongSeq(ACS__POA.ROuLongSeq, PuLongSeq):
    '''
    Properties can be derived from ROuLongSeq only if their IDL derives from
    ACS::ROuLongSeq.
    '''
    #--------------------------------------------------------------------------
    def __init__(self, name, charCompRef, devIORef=None):
        ...
        Raises: Nothing.
        '''
        PuLongSeq.__init__(self, name, charCompRef, devIORef)
        return
    #--------------------------------------------------------------------------
    #--Overriden methods because BACI is inconsistent--------------------------
    #--------------------------------------------------------------------------
...
#--RW property----------------------------------------------------------------
#-----------------------------------------------------------------------------
class RWuLongSeq(ACS__POA.RWuLongSeq, ROuLongSeq):
    '''
    Properties can be derived from ROuLongSeq only if their IDL derives from
    ACS::ROuLongSeq.
    '''
    ...
    def __init__(self, name, charCompRef, devIORef=None):
        ...
        Raises: Nothing.
        '''
        ROuLongSeq.__init__(self, name, charCompRef, devIORef)
        return
    #--------------------------------------------------------------------------
    #--Overriden methods because BACI is inconsistent--------------------------
    #--------------------------------------------------------------------------
