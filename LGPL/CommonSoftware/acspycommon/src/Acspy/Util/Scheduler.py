...
class Scheduler(object):
    ...
    '''
    #--------------------------------------------------------------------------
    def __init__(self, minimum_sleep=1000):
        '''
    ...
    def scheduleTimeout(self,
        ...
        self.lock.acquire()
        self.timeout_dict[timeout_id] = {'time_to_occur':int(time_to_occur),
    ...
    def changeTimeoutFrequency(self, timeout_id, new_frequency):
        ...
        '''
        self.lock.acquire()
        self.timeout_dict[timeout_id]['frequency'] = int(new_frequency)
        self.lock.release()
    #--------------------------------------------------------------------------
    ...
    def __timeoutExecutor(self):
        ...
        while self.alive:
            ...
            for timeout_id in list(self.timeout_dict.keys()):
