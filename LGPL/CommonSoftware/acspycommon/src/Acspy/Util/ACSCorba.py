...
#----------------------------------------------------------------------------
#--Pretty print local and remote exceptions
def user_exception__str__(self):
    return re.sub(r'(errorTrace=|previousError=\[)([^(]*ErrorTrace\(file)', r'\1\n\t\2', self.__repr__())

CORBA.UserException.__str__ = user_exception__str__
#----------------------------------------------------------------------------
...
#        return "CacsCORBA Client"
    ...
    def ping(self): # pragma: NO COVER
        ...
        return 1
    #--CLIENT IDL--------------------------------------------------------------
    def pingCB(self, cb): # pragma: NO COVER
        '''
        Implementation of IDL method.
        '''
        cb.ping(1)
...
def loggingChannel(): # pragma: NO COVER
    ...
    if 'ACS_LOG_BIN' in os.environ and os.environ['ACS_LOG_BIN'] == "true":
