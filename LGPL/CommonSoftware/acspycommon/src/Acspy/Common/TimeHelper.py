...
class TimeUtil(object):
    ...
    def py2epoch(self, seconds):
        ...
        Raises: Nothing
        '''
        return acstime.Epoch(acstime.ACE_BEGIN + int(seconds*10000000))
    #--------------------------------------------------------------------------
    ...
    def py2duration(self, seconds):
        ...
        Raises: Nothing
        '''
        return acstime.Duration(seconds * 10000000)
    #--------------------------------------------------------------------------
    def duration2py(self, duration):
        ...
        Raises: Nothing
        '''
        if isinstance(duration, numbers.Integral):
            duration = acstime.Duration(duration)
            
        sec = float(duration.value) / 10000000
        return sec
