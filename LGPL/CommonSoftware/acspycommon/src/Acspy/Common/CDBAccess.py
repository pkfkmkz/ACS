...
class CDBhandler(ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        self.tempName = self.tempName + six.ensure_str(name, encoding='ascii')
    ...
    def endElement(self, name):
        ...
        '''
        if _DEBUG: # pragma: NO COVER
            print("EE", name, self.tempName, self.tempName.replace(six.ensure_str(name, encoding='ascii') + "/", "", 1))
        self.tempName = self.tempName.replace(six.ensure_str(name, encoding='ascii') + "/", "", 1)
#------------------------------------------------------------------------------
class CDBaccess(object):
    ...
    def getField(self, name, caching=1):
        ...
        Raises: ???
        '''
        if str(name) in self.cache and caching:
