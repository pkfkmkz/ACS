...
template class baci::Monitor<const char*, CORBA::String_out, ACS::CBstring, POA_ACS::Monitorstring, BACIValue::type_string>;
...
template class baci::ROdiscImpl<char*, ACS::CBstring, ACS::stringSeq, ACS::stringSeq_out, ACS::Monitor, MonitorstringImpl, ACE_CString, char*, ACE_CString, POA_ACS::ROstring, ACS::Alarmstring, POA_ACS::CBstring, const char*>;
