...
public:
  ...
  */
  ...
  /// Write ACS::doubleSeq type 
  static void writeDoubleSeq(ACE_CString name, const ACS::doubleSeq & val);

  /// Write ACS::longSeq type 
  static void writeLongSeq(ACE_CString name, const ACS::longSeq & val);

  /// Write ACS::uLongSeq type 
  static void writeULongSeq(ACE_CString name, const ACS::uLongSeq & val);

  /// Write ACS::longLongSeq type 
  static void writeLongLongSeq(ACE_CString name, const ACS::longLongSeq & val);

  /// Write ACS::uLongLongSeq type 
  static void writeULongLongSeq(ACE_CString name, const ACS::uLongLongSeq & val);
  ...
  /// Read ACS::uLongSeq type 
  static ACS::uLongSeq readULongSeq(ACE_CString name);

  /// Read ACS::longLongSeq type 
  static ACS::longLongSeq readLongLongSeq(ACE_CString name);

  /// Read ACS::uLongLongSeq type 
  static ACS::uLongLongSeq readULongLongSeq(ACE_CString name);
