...
#include <baciROlongLongSeq.h>
#include <baciRWlongLongSeq.h>
#include <baciROuLongLongSeq.h>
#include <baciRWuLongLongSeq.h>
...
public:
  ...
  /**
   * Property RWuLongSeqProp contains the actual "RWuLongSeqProp" of the 
   * power supply.
   */ 
  virtual ACS::RWuLongSeq_ptr RWuLongSeqProp ();
  
  /**
   * Property ROuLongSeqProp is the ROuLongSeqProp of the actual "RWuLongSeqProp"
   * of the power supply.
   */ 
  virtual ACS::ROuLongSeq_ptr ROuLongSeqProp ();

  /**
   * Property RWlongLongSeqProp contains the actual "RWlongLongSeqProp" of the 
   * power supply.
   */ 
  virtual ACS::RWlongLongSeq_ptr RWlongLongSeqProp ();
  
  /**
   * Property ROlongLongSeqProp is the ROlongLongSeqProp of the actual "RWlongLongSeqProp"
   * of the power supply.
   */ 
  virtual ACS::ROlongLongSeq_ptr ROlongLongSeqProp ();

  /**
   * Property RWuLongLongSeqProp contains the actual "RWuLongLongSeqProp" of the 
   * power supply.
   */ 
  virtual ACS::RWuLongLongSeq_ptr RWuLongLongSeqProp ();
  
  /**
   * Property ROuLongLongSeqProp is the ROuLongLongSeqProp of the actual "RWuLongLongSeqProp"
   * of the power supply.
   */ 
  virtual ACS::ROuLongLongSeq_ptr ROuLongLongSeqProp ();
...
private:
  ...
  baci::SmartPropertyPointer<baci::ROuLongSeq>    m_ROuLongSeqProp_sp;
  baci::SmartPropertyPointer<baci::RWuLongSeq>    m_RWuLongSeqProp_sp;
  baci::SmartPropertyPointer<baci::ROlongLongSeq>    m_ROlongLongSeqProp_sp;
  baci::SmartPropertyPointer<baci::RWlongLongSeq>    m_RWlongLongSeqProp_sp;
  baci::SmartPropertyPointer<baci::ROuLongLongSeq>    m_ROuLongLongSeqProp_sp;
  baci::SmartPropertyPointer<baci::RWuLongLongSeq>    m_RWuLongLongSeqProp_sp;
