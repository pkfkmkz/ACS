...
typedef ACS::longLongSeq BACIlongLongSeq;
typedef ACS::uLongLongSeq BACIuLongLongSeq;
...
typedef ACS::CBlongLongSeq CBlongLongSeq;
typedef ACS::CBuLongLongSeq CBuLongLongSeq;
...
typedef ACS::CBlongLongSeq_var CBlongLongSeq_var;
typedef ACS::CBuLongLongSeq_var CBuLongLongSeq_var;
