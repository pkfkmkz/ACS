...
CONSTRUCTOR(longLongSeq, BACIlongLongSeq)
CONSTRUCTOR(uLongLongSeq, BACIuLongLongSeq)
...
DESTROY_PTR_TYPE(longLongSeq, BACIlongLongSeq)
DESTROY_PTR_TYPE(uLongLongSeq, BACIuLongLongSeq)
...
CREATE_PTR_TYPE(longLongSeq, BACIlongLongSeq)
CREATE_PTR_TYPE(uLongLongSeq, BACIuLongLongSeq)
...
ASSIGN_PTR_TYPE(longLongSeq, BACIlongLongSeq)
ASSIGN_PTR_TYPE(uLongLongSeq, BACIuLongLongSeq)
...
COMPARE_EQUALS_SEQ_PTR_TYPE(longLongSeq, BACIlongLongSeq)
COMPARE_EQUALS_SEQ_PTR_TYPE(uLongLongSeq, BACIuLongLongSeq)
...
LESS_THAN_DELTA_NUM_SEQ_TYPE(longLongSeq, BACIlongLongSeq, longLong, BACIlongLong)
LESS_THAN_DELTA_NUM_SEQ_TYPE(uLongLongSeq, BACIuLongLongSeq, uLongLong, BACIuLongLong)
...
LESS_THAN_PERCENT_DELTA_NUM_SEQ_TYPE(longLongSeq, BACIlongLongSeq)
LESS_THAN_PERCENT_DELTA_NUM_SEQ_TYPE(uLongLongSeq, BACIuLongLongSeq)
...
ACCESSOR_PTR_TYPE(longLongSeq, BACIlongLongSeq)
ACCESSOR_PTR_TYPE(uLongLongSeq, BACIuLongLongSeq)
...
inline bool BACIValue::stringValue(const char *value)
{
  ...
  if (value==0) {
    ...
    if (ptr_m.pointer) {
      delete[] (ACE_TCHAR*)ptr_m.pointer;
    }
...
MUTATOR_PTR_TYPE(longLongSeq, BACIlongLongSeq)
MUTATOR_PTR_TYPE(uLongLongSeq, BACIuLongLongSeq)
