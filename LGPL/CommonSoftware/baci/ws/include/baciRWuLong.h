#ifndef baciRWuLong_H_
#define baciRWuLong_H_
 ...
 */
typedef  baci::Monitor<ACS_MONITOR(uLong, ACS::uLong)> MonitoruLong;
/** @} */

/** @defgroup RWuLongTemplate RWuLong Class
 * The RWuLong class is a templated typedef so there is no actual inline doc generated for it per-se.
 *  @{
 * The RWuLong class is an implementation of the ACS::RWuLong IDL interface.
 */
