#ifndef baciRWboolean_H_
#define baciRWboolean_H_
 ...
 */
typedef  baci::Monitor<ACS_MONITOR(boolean, CORBA::Boolean)> Monitorboolean;
/** @} */

/** @defgroup RWbooleanTemplate RWboolean Class
 * The RWboolean class is a templated typedef so there is no actual inline doc generated for it per-se.
 *  @{
 * The RWboolean class is an implementation of the ACS::RWboolean IDL interface.
 */
