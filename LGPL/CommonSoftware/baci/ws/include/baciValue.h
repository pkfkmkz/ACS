...
class baci_EXPORT BACIValue
{
  ...
  public:
	...
	/// boolean.
	type_booleanSeq=16,
	/// Sequence of longLong-s
	type_longLongSeq=17,
	/// Sequence of uLongLong-s
	type_uLongLongSeq=18
    };
     ...
     *     "uLong","uLongSeq","boolean","booleanSeq","longLongSeq","uLongLongSeq"
     ...
     *     "boolean","booleanSeq","longLongSeq","uLongLongSeq"
     * Furthermore, this array can be indexed using the #Type enum.
     * <br><hr>
     */
...
//TOBE deleted    BACIValue(const BACIpattern &value);
    ...
    /** Constructor BACIlongLongSeq
     * @param value A constant reference to a value which will be this #BACIValue
     * object's underlying value.
     * <br><hr>
     */
    BACIValue(const BACIlongLongSeq &value);
    /** Constructor BACIuLongLongSeq
     * @param value A constant reference to a value which will be this #BACIValue
     * object's underlying value.
     * <br><hr>
     */
    BACIValue(const BACIuLongLongSeq &value);
...
//TOBE deleted    static Type mapType(BACIpattern *v=0){  ACE_UNUSED_ARG(v); return type_pattern; }
    ...
    /**
     * Given a pointer to a baci::BACIlongLongSeq, this static method returns a the #Type enumeration value.
     * @param v Pointer to a BACI data type
     * @return BACIValue::type_longSeq
     * <br><hr>
     */
    static Type mapType(BACIlongLongSeq *v=0){  ACE_UNUSED_ARG(v); return type_longLongSeq; }
    /**
     * Given a pointer to a baci::BACIuLongLongSeq, this static method returns a the #Type enumeration value.
     * @param v Pointer to a BACI data type
     * @return BACIValue::type_uLongLongSeq
     * <br><hr>
     */
    static Type mapType(BACIuLongLongSeq *v=0){  ACE_UNUSED_ARG(v); return type_uLongLongSeq; }
    /**
...
//TOBE deleted    BACIpattern getValue(BACIpattern *v=0) const;
    ...
    /**
     * Returns this object's underlying BACI value as a longLong sequence.
     * @return longLong sequence value of this object or 0 if it's not a longLong sequence.
     * <br><hr>
     */
    BACIlongLongSeq longLongSeqValue() const;
    /**
     * Returns this object's underlying BACI value as a longLong sequence.
     * @param v is a BACIlongLongSeq *. Invoker should just provide a null reference.
     * @return longLong sequence value of this object or 0 if it's not a longLong sequence.
     * <br><hr>
     */
    BACIlongLongSeq getValue(BACIlongLongSeq *v=0) const;
    /**
     * Returns this object's underlying BACI value as a unsigned longLong sequence.
     * @return unsigned longLong sequence value of this object or 0 if it's not an unsigned longLong sequence.
     * <br><hr>
     */
    BACIuLongLongSeq uLongLongSeqValue() const;
    /**
     * Returns this object's underlying BACI value as an unsigned longLong sequence.
     * @param v is a BACIuLongLongSeq *. Invoker should just provide a null reference.
     * @return unsigned longLong sequence value of this object or 0 if it's not an unsigned longLong sequence.
     * <br><hr>
     */
    BACIuLongLongSeq getValue(BACIuLongLongSeq *v=0) const;
    /**
...
//TOBE deleted    bool setValue(const BACIpattern &value, const CORBA::Any &anyVal);
    ...
    /**
     * Mutator
     * @param value Reference to a BACIlongLongSeq that this object will copy.
     * @return If the value currently contains other type of data than the one being
     * stored, the operation has no effect and false is returned.
     * <br><hr>
     */
    bool longLongSeqValue(const BACIlongLongSeq &value);
    /**
     * Mutator
     * @param value Reference to a BACIlongLongSeq that this object will copy.
     * @return If the value currently contains other type of data than the one being
     ...
     * <br><hr>
     */
    bool setValue(const BACIlongLongSeq &value);
    /**
     * Mutator
     * @param value Reference to a BACIuLongLongSeq that this object will copy.
     * @return If the value currently contains other type of data than the one being
     * stored, the operation has no effect and false is returned.
     * <br><hr>
     */
    bool uLongLongSeqValue(const BACIuLongLongSeq &value);
    /**
     * Mutator
     * @param value Reference to a BACIuLongLongSeq that this object will copy.
     * @return If the value currently contains other type of data than the one being
     ...
     * <br><hr>
     */
    bool setValue(const BACIuLongLongSeq &value);
    /**
     * Mutator
