...
//  ACE_CString getName() const { return name; }
  ...
  ACS::TimeInterval getMTMaxStartDelay() const { return monitorThreadMaxStartDelay_m; }
  void setMTMaxStartDelay(const ACS::TimeInterval& monitorThreadMaxStartDelay);
...
private:
  ...
  BACIPropertyVector propertyVector_m;
    ...
    ACS::TimeInterval monitorThreadMaxStartDelay_m;
  ...
  size_t monitorThreadStackSize_m;
