...
class ValueTestCase : public CPPUNIT_NS::TestFixture
{
  ...
  protected:
    ...
    void testULongSeq()
	{
	    ...
	    /*
	    CORBA::ULong sbd[] = {1L};
	    BACIuLongSeq sbdSeq(3, 3, sbd);
	    
	    CORBA::ULong lbd[] = {3L};
	    BACIuLongSeq lbdSeq(3, 3, lbd);
	    ...
	    testBaciValueType<BACIuLongSeq>(sbdSeq, lbdSeq, sbDelta, lbDelta);
	    */
	}
    ...
    void testLongLongSeq()
	{
	    //The implementation is broken as these do not pass!
	    /*
	    ACS::longLong sbd[] = {1L};
	    BACIlongLongSeq sbdSeq(3, 3, sbd);
	    
	    ACS::longLong lbd[] = {3L};
	    BACIlongLongSeq lbdSeq(3, 3, lbd);
	    ...
	    testBaciValueType<BACIlongLongSeq>(sbdSeq, lbdSeq, sbDelta, lbDelta);
	    */
	}

    void testULongLongSeq()
	{
	    //The implementation is broken as these do not pass!
	    /*
	    ACS::uLongLong sbd[] = {1L};
	    BACIuLongLongSeq sbdSeq(3, 3, sbd);
	    
	    ACS::uLongLong lbd[] = {3L};
	    BACIuLongLongSeq lbdSeq(3, 3, lbd);
	    ...
	    testBaciValueType<BACIuLongLongSeq>(sbdSeq, lbdSeq, sbDelta, lbDelta);
	    */
	}
