...
BaciTestClassImpl::BaciTestClassImpl(const ACE_CString& name,
    ...
    m_ROuLongSeqProp_sp(new ROuLongSeq(name+":ROuLongSeqProp", getComponent()),this), 
    m_RWuLongSeqProp_sp(new RWuLongSeq(name+":RWuLongSeqProp", getComponent()),this),
    m_ROlongLongSeqProp_sp(new ROlongLongSeq(name+":ROlongLongSeqProp", getComponent()),this), 
    m_RWlongLongSeqProp_sp(new RWlongLongSeq(name+":RWlongLongSeqProp", getComponent()),this),
    m_ROuLongLongSeqProp_sp(new ROuLongLongSeq(name+":ROuLongLongSeqProp", getComponent()),this), 
    m_RWuLongLongSeqProp_sp(new RWuLongLongSeq(name+":RWuLongLongSeqProp", getComponent()),this)
{
...
ACS::RWuLongSeq_ptr
BaciTestClassImpl::RWuLongSeqProp ()
{
  if (m_RWuLongSeqProp_sp==0)
	  return ACS::RWuLongSeq::_nil();

  ACS::RWuLongSeq_var prop = ACS::RWuLongSeq::_narrow(m_RWuLongSeqProp_sp->getCORBAReference()
						    );
  return prop._retn();
}

ACS::ROuLongSeq_ptr
BaciTestClassImpl::ROuLongSeqProp ()
{
  if (m_ROuLongSeqProp_sp==0)
	  return ACS::ROuLongSeq::_nil();

  ACS::ROuLongSeq_var prop = ACS::ROuLongSeq::_narrow(m_ROuLongSeqProp_sp->getCORBAReference()
						    );
  return prop._retn();

}

ACS::RWlongLongSeq_ptr
BaciTestClassImpl::RWlongLongSeqProp ()
{
  if (m_RWlongLongSeqProp_sp==0)
	  return ACS::RWlongLongSeq::_nil();

  ACS::RWlongLongSeq_var prop = ACS::RWlongLongSeq::_narrow(m_RWlongLongSeqProp_sp->getCORBAReference()
						    );
  return prop._retn();
}

ACS::ROlongLongSeq_ptr
BaciTestClassImpl::ROlongLongSeqProp ()
{
  if (m_ROlongLongSeqProp_sp==0)
	  return ACS::ROlongLongSeq::_nil();

  ACS::ROlongLongSeq_var prop = ACS::ROlongLongSeq::_narrow(m_ROlongLongSeqProp_sp->getCORBAReference()
						    );
  return prop._retn();

}

ACS::RWuLongLongSeq_ptr
BaciTestClassImpl::RWuLongLongSeqProp ()
{
  if (m_RWuLongLongSeqProp_sp==0)
	  return ACS::RWuLongLongSeq::_nil();

  ACS::RWuLongLongSeq_var prop = ACS::RWuLongLongSeq::_narrow(m_RWuLongLongSeqProp_sp->getCORBAReference()
						    );
  return prop._retn();
}

ACS::ROuLongLongSeq_ptr
BaciTestClassImpl::ROuLongLongSeqProp ()
{
  if (m_ROuLongLongSeqProp_sp==0)
	  return ACS::ROuLongLongSeq::_nil();

  ACS::ROuLongLongSeq_var prop = ACS::ROuLongLongSeq::_narrow(m_ROuLongLongSeqProp_sp->getCORBAReference()
						    );
  return prop._retn();
