...
int main (int argc, char **argv)
{
	...
	ACS_SHORT_LOG((LM_INFO,"baciTestClient: Trying to get ACS::RWuLongSeq RWuLongSeqProp..."));
        ACS::uLongSeq_var new_seq_ul = new ACS::uLongSeq();
	testRWSeq<CORBA::Long, ACS::uLongSeq_var, ACS::RWuLongSeq_var>(ps->RWuLongSeqProp(),new_seq_ul,static_cast<ACS::uLong>(atol(argv[1])));

	ACS_SHORT_LOG((LM_INFO,"baciTestClient: Trying to get ACS::ROuLongSeq ROuLongSeqProp..."));
	testROSeq<ACS::uLongSeq_var, ACS::ROuLongSeq_var>(ps->ROuLongSeqProp());

	ACS_SHORT_LOG((LM_INFO,"baciTestClient: Trying to get ACS::RWlongLongSeq RWlongLongSeqProp..."));
        ACS::longLongSeq_var new_seq_ll = new ACS::longLongSeq();
	testRWSeq<CORBA::Long, ACS::longLongSeq_var, ACS::RWlongLongSeq_var>(ps->RWlongLongSeqProp(),new_seq_ll,atoll(argv[1]));

	ACS_SHORT_LOG((LM_INFO,"baciTestClient: Trying to get ACS::ROlongLongSeq ROlongLongSeqProp..."));
	testROSeq<ACS::longLongSeq_var, ACS::ROlongLongSeq_var>(ps->ROlongLongSeqProp());

	ACS_SHORT_LOG((LM_INFO,"baciTestClient: Trying to get ACS::RWuLongLongSeq RWuLongLongSeqProp..."));
        ACS::uLongLongSeq_var new_seq_ull = new ACS::uLongLongSeq();
	testRWSeq<CORBA::Long, ACS::uLongLongSeq_var, ACS::RWuLongLongSeq_var>(ps->RWuLongLongSeqProp(),new_seq_ull,static_cast<ACS::uLongLong>(atoll(argv[1])));

	ACS_SHORT_LOG((LM_INFO,"baciTestClient: Trying to get ACS::ROuLongLongSeq ROuLongLongSeqProp..."));
	testROSeq<ACS::uLongLongSeq_var, ACS::ROuLongLongSeq_var>(ps->ROuLongLongSeqProp());
