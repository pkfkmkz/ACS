...
namespace Logging 
{
	...
	using LoggerSmartPtr = acsutil::SmartPtr<Logger>;
	...
	typedef void (*ConfigureLoggerFunction)(const std::string& loggerName);
		...
		class Logger_ptr{
		  public:
			Logger_ptr(){globalLogger_m=nullptr; anonymousLogger_m=nullptr; staticLogger_m=nullptr;}
			~Logger_ptr(){globalLogger_m=nullptr; anonymousLogger_m=nullptr; staticLogger_m=nullptr;}
			/**
	...
	static void	setAnonymousLogger(Logger* anonyLogger);
	...
	static void	setStaticLogger(Logger* anonyLogger);
	...
	static void setGlobalLogger(Logger* globalLogger);
