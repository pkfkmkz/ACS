...
static const char *rcsId="@(#) $Id: loggingLogger.cpp,v 1.22 2012/01/20 22:07:44 tstaig Exp $"; 
...
namespace Logging {
    ...
    void
    Logger::setGlobalLogger(Logger* globalLogger)
    {
	setGlobalLogger(Logger::LoggerSmartPtr(globalLogger));
    }
    // -------------------------------------------------------
    void
    ...
    void
    Logger::setStaticLogger(Logger* staticLogger)
    {
	setStaticLogger(Logger::LoggerSmartPtr(staticLogger));
    }
    // -------------------------------------------------------
    void
    ...
    void
    Logger::setAnonymousLogger(Logger* anonyLogger)
    {
	setAnonymousLogger(Logger::LoggerSmartPtr(anonyLogger));
    }
    // -------------------------------------------------------
    std::string
