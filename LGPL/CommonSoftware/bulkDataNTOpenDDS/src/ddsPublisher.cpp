...
int main() {
  ...
  DDS::DataWriter *         data_writer = NULL;
  ...
  DDS::ReturnCode_t        retcode;
    ...
    OpenDDS::DCPS::set_DCPS_debug_level(4);
	...
	*/
    ...
    Messenger::MessageTypeSupport_var mts =     new Messenger::MessageTypeSupportImpl();  if (DDS::RETCODE_OK != mts->register_type(participant, "")) {    std::cerr << "register_type failed." << std::endl;    return 1;  }
