...
/**
 * This exception indicates that BulkData API fails to enable a certain
 * DDS entity for some reason.
 *
 * @author Takashi Nakamoto
 */
@SuppressWarnings("serial")
public class FailedToEnableException extends DdsException {
    /**
     ...
     */
    public FailedToEnableException(String msg,
                                   RETCODE_ERROR cause,
