...
public class BulkDataNTFrameTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ACSBulkData::BulkDataNTFrame";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BulkDataNTFrameTypeSupport _singleton
    = new BulkDataNTFrameTypeSupport();
    ...
    */
    public static BulkDataNTFrameTypeSupport get_instance() {
        return _singleton;
    }

    public static BulkDataNTFrameTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BulkDataNTFrameTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return BulkDataNTFrame.create();
    }
    ...
    * <code>this</code> is not a <code>BulkDataNTFrame</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        BulkDataNTFrame typedDst = (BulkDataNTFrame) destination;
        BulkDataNTFrame typedSrc = (BulkDataNTFrame) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += _cdrPrimitiveType.getIntMaxSizeSerialized(currentAlignment) ;
        currentAlignment += _cdrPrimitiveType.getIntMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=_cdrPrimitiveType.getByteSequenceMaxSizeSerialized(currentAlignment, (alma.acs.bulkdata.ACSBulkData.FRAME_MAX_LEN.VALUE));
        if (include_encapsulation) {
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        BulkDataNTFrame typedSrc = (BulkDataNTFrame) sample;
        ...
        currentAlignment  +=   _cdrPrimitiveType.getByteSequenceSerializedSize(
            epd.getAlignment(currentAlignment) , typedSrc.data );      
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.typeOfdata);
            dst.writeInt(typedSrc.restDataLength);
            dst.writeByteSeq(typedSrc.data,(alma.acs.bulkdata.ACSBulkData.FRAME_MAX_LEN.VALUE));
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BulkDataNTFrame typedDst = (BulkDataNTFrame) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.typeOfdata = src.readInt();
                typedDst.restDataLength = src.readInt();
                src.readByteSequence(typedDst.data, (alma.acs.bulkdata.ACSBulkData.FRAME_MAX_LEN.VALUE));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BulkDataNTFrame typedDst = (BulkDataNTFrame) sample;
            deserialize_sample(
    ...
    int mask) {
        return new BulkDataNTFrameDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BulkDataNTFrameDataReader(native_reader, listener, mask, this);   
    ...
    protected BulkDataNTFrameTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, BulkDataNTFrameTypeCode.VALUE, BulkDataNTFrame.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BulkDataNTFrameTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, BulkDataNTFrameTypeCode.VALUE, BulkDataNTFrame.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
