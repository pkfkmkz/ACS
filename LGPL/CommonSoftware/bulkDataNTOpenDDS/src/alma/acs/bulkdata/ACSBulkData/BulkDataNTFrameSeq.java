...
/**
* A sequence of BulkDataNTFrame instances.
*/
public final class BulkDataNTFrameSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BulkDataNTFrameSeq() {
        super(BulkDataNTFrame.class);
    }

    public BulkDataNTFrameSeq (int initialMaximum) {
        super(BulkDataNTFrame.class, initialMaximum);
    }

    public BulkDataNTFrameSeq (Collection<?> elements) {
        super(BulkDataNTFrame.class, elements);
    }

    public  BulkDataNTFrame get(int index) { 
        return (BulkDataNTFrame) super.get(index); 
    }
