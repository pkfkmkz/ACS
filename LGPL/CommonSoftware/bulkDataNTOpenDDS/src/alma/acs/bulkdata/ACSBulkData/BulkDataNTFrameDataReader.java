...
/**
* A reader for the BulkDataNTFrame user type.
*/
public class BulkDataNTFrameDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(BulkDataNTFrameSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    ...
    public void take(BulkDataNTFrameSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(BulkDataNTFrameSeq received_data, 
    ...
    public void take_w_condition(BulkDataNTFrameSeq received_data, 
    SampleInfoSeq info_seq,
    int max_samples,
    ReadCondition condition) {
    ...
    public void read_next_sample(BulkDataNTFrame received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }

    public void take_next_sample(BulkDataNTFrame received_data, SampleInfo sample_info) {
        take_next_sample_untyped(received_data, sample_info);
    }

    public void read_instance(BulkDataNTFrameSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(BulkDataNTFrameSeq received_data, SampleInfoSeq info_seq,
    int max_samples, InstanceHandle_t a_handle, int sample_states,
    int view_states, int instance_states) {
    ...
    public void read_instance_w_condition(BulkDataNTFrameSeq received_data,
    ...
    public void take_instance_w_condition(BulkDataNTFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void read_next_instance(BulkDataNTFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance(BulkDataNTFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, int sample_states, int view_states,
    int instance_states) {
    ...
    public void read_next_instance_w_condition(BulkDataNTFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void take_next_instance_w_condition(BulkDataNTFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(BulkDataNTFrameSeq received_data, SampleInfoSeq info_seq) {
        return_loan_untyped(received_data, info_seq);
    }

    public void get_key_value(BulkDataNTFrame key_holder, InstanceHandle_t handle){
        get_key_value_untyped(key_holder, handle);
    }

    public InstanceHandle_t lookup_instance(BulkDataNTFrame key_holder) {
    ...
    /*package*/  BulkDataNTFrameDataReader (long native_reader, DataReaderListener listener,
