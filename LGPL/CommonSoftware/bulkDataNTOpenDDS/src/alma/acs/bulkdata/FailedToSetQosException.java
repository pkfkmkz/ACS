...
/**
 * This exception indicates that BulkData API fails to set QoS to
 * the underlying DDS library.
 *
 * @author Takashi Nakamoto
 */
@SuppressWarnings("serial")
public class FailedToSetQosException extends DdsException {
    /**
     ...
     */
    public FailedToSetQosException(String msg,
                                   RETCODE_ERROR cause,
