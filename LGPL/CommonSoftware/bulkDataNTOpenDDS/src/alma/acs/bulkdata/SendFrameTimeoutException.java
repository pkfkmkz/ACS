...
/**
 * This exception indicates that write() operation of Data Writer of the 
 * underlying DDS library timed out.
 * 
 * @author Takashi Nakamoto
 */
@SuppressWarnings("serial")
public class SendFrameTimeoutException extends DdsException {
    /**
     ...
     */
    public SendFrameTimeoutException(String msg,
                                     RETCODE_ERROR cause,
