...
//			0, DDS::STATUS_MASK_NONE);
  ...
  ddsCfg_m.profileList.get_publisher_qos(pub_qos,
  ...
  DDS::Publisher_ptr pub = participant_m->create_publisher(pub_qos,
                                                           0,
...
ACSBulkData::BulkDataNTFrameDataWriter* BulkDataNTDDSPublisher::createDDSWriter(DDS::Topic *topic, DDS::DataWriterListener *listener)
{
  ...
  // Apply default bulkDataNT profile
  ddsCfg_m.profileList.get_datawriter_qos(dw_qos,
      ACE_TEXT_CHAR_TO_TCHAR(ddsCfg_m.DEFAULT_SENDER_FLOW_PROFILE),
  ...
  DDS::DataWriter_ptr temp_dw = publisher_m->create_datawriter(topic,
                                                               dw_qos,
	...
	dataWriter_m = ACSBulkData::BulkDataNTFrameDataWriter::_narrow(temp_dw);
...
void BulkDataNTDDSPublisher::setWriteBlockingTime(double frameTimeout)
{
	...
	CORBA::Long frameTimeoutSec = static_cast<CORBA::Long>(frameTimeout);
	CORBA::Long frameTimeoutNanosec = 1000000 * static_cast<CORBA::Long>(frameTimeout - frameTimeoutSec);
