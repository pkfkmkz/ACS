...
#include "bulkDataOpenDDSFlow.h"
#include "bulkDataOpenDDSDDSPublisher.h"
#include "bulkDataOpenDDSSenderStream.h"
#include "bulkDataOpenDDSSenderFlowCallback.h"
#include "bulkDataOpenDDSWriterListener.h"
#include <ACE.h>
#include <bulkDataC.h>
...
//	DDS::DataWriterProtocolStatus startSendDwps;  //RTI
//	DDS::DataWriterCacheStatus startSendDwcs;     //RTI
...
public:
	 ...
	 */
	void startSend(ACE_Message_Block *param = 0, bool resetReceiver=true);
	 ...
	 * @exception #StartSendErrorExImpl
	 */
	void startSend(const unsigned char *param, size_t len, bool resetReceiver=true);
...
protected:
	...
	/// frame
	ACSBulkData::BulkDataNTFrame_var frame_m;

  /// Handle to be registered in dataWriter
  DDS::InstanceHandle_t handle_m;
