...
*
* "@(#) $Id: bulkDataNTReceiverStream.i,v 1.26 2012/09/13 10:59:14 bjeram Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
...
AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::BulkDataNTReceiverStream(const char* streamName, const ReceiverStreamConfiguration &cfg, bool enabledCallingCBforAllFlows)
: BulkDataNTReceiverStreamBase(streamName, cfg), notRemoveFromMap_m(false), enabledCallingCBforAllFlows_m(enabledCallingCBforAllFlows)
{
...
template<class TReceiverCallback>
AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::BulkDataNTReceiverStream(const char* receiverName, const char* streamName, const ReceiverStreamConfiguration &cfg, bool enabledCallingCBforAllFlows)
: BulkDataNTReceiverStreamBase(receiverName, streamName, cfg), notRemoveFromMap_m(false), enabledCallingCBforAllFlows_m(enabledCallingCBforAllFlows)
{
	AUTO_TRACE(__PRETTY_FUNCTION__);
...
template<class TReceiverCallback>
AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::~BulkDataNTReceiverStream()
{
	AUTO_TRACE(__PRETTY_FUNCTION__);
...
AcsBulkdata::BulkDataNTReceiverFlow* 
    AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::createFlow
    (
        const char *flowName,
    ...
    )
{
	...
	{
		ACS_BD_Errors::FlowAlreadyExistsExImpl ex(__FILE__, __LINE__, __PRETTY_FUNCTION__);
	...
	{
		ACS_BD_Errors::FlowCreateProblemExImpl ex(acsEx, __FILE__, __LINE__, __PRETTY_FUNCTION__);
		ex.setStreamName(streamName_m.c_str());
		ex.setFlowName(flowName);
		throw ex;
	}
	catch(const std::exception &stdEx)
	{
		...
		ACS_BD_Errors::FlowCreateProblemExImpl ex(stdExWrapper, __FILE__, __LINE__, __PRETTY_FUNCTION__);
		ex.setStreamName(streamName_m.c_str());
		ex.setFlowName(flowName);
		throw ex;
	}
	catch(...)
	{
		...
		ACS_BD_Errors::FlowCreateProblemExImpl ex(uex, __FILE__, __LINE__, __PRETTY_FUNCTION__);
		ex.setStreamName(streamName_m.c_str());
		ex.setFlowName(flowName);
		throw ex;
	}//try-catch
...
template<class TReceiverCallback>
AcsBulkdata::BulkDataNTReceiverFlow* 
AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::getFlow(const char *flowName)
{
	AUTO_TRACE(__PRETTY_FUNCTION__);
	...
	{
		ACS_BD_Errors::FlowNotExistExImpl ex(__FILE__, __LINE__, __PRETTY_FUNCTION__);
		ex.setStreamName(streamName_m.c_str());
		ex.setFlowName(flowName);
		throw ex;
	}
...
template<class TReceiverCallback>
bool AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::existFlow(const char* flowName)
{
	AUTO_TRACE(__PRETTY_FUNCTION__);
...
template<class TReceiverCallback>
void AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::removeFlowFromMap(const char* flowName)
{
...
AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::getFlowNames()
{
...
template<class TReceiverCallback>
unsigned int AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::getFlowNumber()
{
  return receiverFlows_m.size();
}//getFlowNumber

template<class TReceiverCallback>
void AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::enableCallingCBforAllFlows()
{
	AUTO_TRACE(__PRETTY_FUNCTION__);
...
template<class TReceiverCallback>
void AcsBulkdata::BulkDataNTReceiverStream<TReceiverCallback>::disableCallingCBforAllFlows()
{
	AUTO_TRACE(__PRETTY_FUNCTION__);
