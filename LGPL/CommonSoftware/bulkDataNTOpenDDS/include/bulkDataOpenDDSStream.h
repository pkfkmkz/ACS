...
protected:
  ...
  DDS::DomainId_t domainID_m;
	...
	static ACE_Recursive_Thread_Mutex globalPartMutex_m; /// protection global participant + counter
	static ACE_Recursive_Thread_Mutex DDSFactoryMutex_m; /// protection DDS factory ( counter)
};//class BulkDataNTStream
