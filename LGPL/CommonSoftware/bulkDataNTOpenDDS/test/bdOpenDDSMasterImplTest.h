...
class BulkDataNTMasterImpl : public BulkDataNTReceiverImpl<TestCB>
{
  ...
  protected:
    ...
    AcsBulkdata::ReceiverStreamConfiguration*  rcvStrCfg_m;
    AcsBulkdata::ReceiverFlowConfiguration *rcvFlowCfg_m;
    AcsBulkdata::SenderStreamConfiguration*  sndStrCfg_m;
    AcsBulkdata::SenderFlowConfiguration *sndFlowCfg_m;

    AcsBulkdata::BulkDataNTReceiverStream<TestCB> *rcvStream1_m, *rcvStream2_m;
    AcsBulkdata::BulkDataNTReceiverFlow *rcvFlow1_m, *rcvFlow2_m;

    AcsBulkdata::BulkDataNTSenderStream *sndStream1_m, *sndStream2_m;
    AcsBulkdata::BulkDataNTSenderFlow *sndFlow1_m, *sndFlow2_m;
