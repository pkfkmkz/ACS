...
*/
#include "bdOpenDDSSenderImplTest.h"
...
void bdNTSenderImplTest::resetSend() {
    ...
    getSenderStream("TestStream")->getFlow("FullResolutionDataFlow")->resetSend();
    getSenderStream("TestStream")->getFlow("ChannelAverageDataFlow")->resetSend();
}
