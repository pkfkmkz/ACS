...
import alma.ict21770.MiddleCCPOATie;
 ...
 * <p>
 * Name="MIDDLECC_1" Code="alma.ict21770.MiddleCCImpl.MiddleCCComponentHelper" Type="IDL:alma/ict21770/MiddleCC:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class MiddleCCComponentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public MiddleCCComponentHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return MiddleCCOperations.class;
	}
