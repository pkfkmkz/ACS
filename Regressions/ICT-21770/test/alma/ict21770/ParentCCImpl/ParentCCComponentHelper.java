...
import alma.ict21770.ParentCCPOATie;
 ...
 * <p>
 * Name="PARENTCC_1" Code="alma.ict21770.ParentCCImpl.ParentCCComponentHelper" Type="IDL:alma/ict21770/ParentCC:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class ParentCCComponentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public ParentCCComponentHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return ParentCCOperations.class;
	}
