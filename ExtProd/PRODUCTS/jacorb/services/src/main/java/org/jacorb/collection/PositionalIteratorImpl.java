...
class PositionalIteratorImpl implements
        org.omg.CosCollection.IteratorOperations
{
    ...
    /* ------------------------------------------------------------------------- */
    public boolean retrieve_element (AnyHolder element) throws IteratorInvalid,
            IteratorInBetween
    {
        synchronized (collection)
        {
    ...
    public boolean retrieve_element_set_to_next (AnyHolder element,
            org.omg.CORBA.BooleanHolder more) throws IteratorInvalid,
            IteratorInBetween
    {
        synchronized (collection)
        {
    ...
    /* ------------------------------------------------------------------------- */
    public boolean retrieve_next_n_elements (int n, AnySequenceHolder result,
            org.omg.CORBA.BooleanHolder more) throws IteratorInvalid,
            IteratorInBetween
    {
    ...
    /* ------------------------------------------------------------------------- */
    public boolean remove_element_set_to_next () throws IteratorInvalid,
            IteratorInBetween
    {
        synchronized (collection)
        {
    ...
    public boolean remove_next_n_elements (int n,
            org.omg.CORBA.IntHolder actual_number) throws IteratorInvalid,
            IteratorInBetween
    {
        synchronized (collection)
        {
    ...
    /* ------------------------------------------------------------------------- */
    public boolean not_equal_remove_element_set_to_next (
            org.omg.CosCollection.Iterator test) throws IteratorInvalid,
            IteratorInBetween
    {
        synchronized (collection)
        {
    ...
    /* ------------------------------------------------------------------------- */
    public void replace_element (Any element) throws IteratorInvalid,
    ...
    public boolean not_equal_replace_element_set_to_next (
            org.omg.CosCollection.Iterator test, Any element)
            throws IteratorInvalid, IteratorInBetween, ElementInvalid
    {
        synchronized (collection)
        {
    ...
    public boolean add_n_elements_set_iterator (Any[] elements,
            org.omg.CORBA.IntHolder actual_number) throws ElementInvalid
    {
        synchronized (collection)
        {
            actual_number.value = 0;
    ...
    /* ------------------------------------------------------------------------- */
    public synchronized boolean is_for (
            org.omg.CosCollection.Collection collector)
    {
